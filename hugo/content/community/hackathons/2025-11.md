...
path_base_for_github_subdir:
  from: content/community/hackathons/2025-11.md
  to: 2025-11.md
title: "November 2025"
weight: -202511
prev: false
...
![Group picture](/community/hackathons/images/2025-11/group-picture.jpeg)
...
Running E2E tests in a self-hosted shoot cluster allows us to *"eat our own dog food"*.
...
1. Reduce load on the Prow build clusters.
1. Do this securely.
...
![Prow CPU metrics without cache showing 12 CPUs being used during build](/community/hackathons/images/2025-11/prow-go-build-cache/prow-without-cache.webp)
...
![Prow CPU metrics with cache showing 2 CPUs being used during build](/community/hackathons/images/2025-11/prow-go-build-cache/prow-with-cache.webp)
...
The API server of a [self-hosted `Shoot` cluster](/docs/proposals/0028-self-hosted-shoot-clusters/) with managed infrastructure needs a mechanism to be reliably exposed for external access.
