...
path_base_for_github_subdir:
  from: content/community/review-meetings/2024-reviews.md
  to: 2024-reviews.md
title: '2024'
weight: -2024
prev: false
...
- 📖 [DEVELOPER] [This document](/contribute/gardener/process/) now contains a guide for developers how to handle deprecations and backwards-compatibility of changes. [#10294](https://github.com/gardener/gardener/pull/10294)
...
- 🪓 [OPERATOR] The [Resource Size Validator](/docs/gardener/concepts/admission-controller/) of the `gardener-admission-controller` ignores `status` subresource and `metadata.managedFields` for resource size limits. [...] [#10011](https://github.com/gardener/gardener/pull/10011)
...
| [@MartinWeindel](https://github.com/MartinWeindel) | `5m` | 🔄 [Secrets Manager](/contribute/gardener/secrets_management/): Configurable Validity Percentage For Auto-Renewal | [#9819](https://github.com/gardener/gardener/pull/9819) |
...
- ❗️ [DEVELOPER] The legacy method for extensions to provide observability configuration for shoot clusters (via `ConfigMap`s labelled with `extensions.gardener.cloud/configuration=monitoring`) is deprecated and will be removed in a future release. Please refer to [this document](/docs/gardener/extensions/logging-and-monitoring/#extensions-monitoring-integration) to get information about the new, recommended way, and start migrating to it. [#9695](https://github.com/gardener/gardener/pull/9695)
