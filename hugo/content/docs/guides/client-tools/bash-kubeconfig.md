...
![port-forward](/docs/guides/client-tools/images/howto-kubeconfig-bash.gif)
...
![port-forward](/docs/guides/client-tools/images/howto-bash_kubeconfig_powershell.webp)
