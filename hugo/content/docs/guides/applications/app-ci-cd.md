...
For help with `server-ca-discovery-url`, see: [Retrieve the CA of a shoot cluster via Gardener Discovery Server](/docs/other-components/gardener-discovery-server/api/#retrieve-the-ca-of-a-shoot-cluster).
...
- [Gardener Structured Authentication](/docs/gardener/shoot/shoot_access/)
