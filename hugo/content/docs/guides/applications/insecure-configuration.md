...
![teaser](/docs/guides/applications/images/teaser.svg)
...
![](/docs/guides/applications/images/image3.webp)*The API server can have many clients of various kinds*<br/><br/><br/>
...
![](/docs/guides/applications/images/image2.webp)*API server clients can reach the API server through an authenticating proxy*<br/><br/><br/>
...
![](/docs/guides/applications/images/image8.webp)*What happens when a client bypasses the proxy, connecting directly to the API server?*<br/><br/><br/>
...
![](/docs/guides/applications/images/image7.webp)*The API server is mostly a component that receives requests*<br/><br/><br/>
...
![](/docs/guides/applications/images/image1.webp)*But the API server also initiates some connections, for example, to worker nodes*<br/><br/><br/>
...
![](/docs/guides/applications/images/image6.webp)*The API server is tricked to connect to other components*<br/><br/><br/>
...
In Gardener, this has been fixed with Kubernetes network policies along with changes to ensure the API server does not need to contact the metadata service. You can see more details in the [announcements on the Gardener mailing list](https://groups.google.com/forum/#!forum/gardener).
...
![](/docs/guides/applications/images/image5.webp)*Prometheus and Grafana can be used to monitor worker nodes*<br/><br/><br/>
...
![](/docs/guides/applications/images/image9.webp)*Credentials can be retrieved from the debugging console of Chrome*<br/><br/><br/>

![](/docs/guides/applications/images/image4.webp)*Adding a Grafana data source is a way to issue HTTP requests to arbitrary targets*<br/><br/><br/>
