...
1. Navigate to *Dashboards &rightarrow; Data Sources*
...
1. In the left corner, select *Dashboards &rightarrow; New* to create a new dashboard
1. Select *Graph* to create a new graph
1. Next, select the *Panel Title &rightarrow; Edit*
