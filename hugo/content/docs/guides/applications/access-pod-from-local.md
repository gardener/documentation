...
1. Note down the name of the pod in question as `<your-pod-name>`
1. Run `kubectl port-forward <your-pod-name> <local-port>:<your-app-port>`
1. Run a web browser or curl locally and enter the URL: `http(s)://localhost:<local-port>`
...
![port-forward](/docs/guides/applications/images/howto-port-forward.svg)
