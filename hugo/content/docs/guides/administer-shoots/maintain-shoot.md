...
For more information, see [Version Classifications](/docs/gardener/shoot-operations/shoot_versions/#version-classifications).
...
For more information, see [Confine Specification Changes/Update Roll Out](/docs/gardener/shoot/shoot_maintenance/#confine-specification-changesupdates-roll-out).
