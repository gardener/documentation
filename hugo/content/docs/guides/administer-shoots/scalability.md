...
path_base_for_github_subdir:
  from: content/docs/guides/administer-shoots/scalability.md
  to: scalability.md
...
![Pods and Nodes](/docs/guides/administer-shoots/images/pod-nodes.webp)
