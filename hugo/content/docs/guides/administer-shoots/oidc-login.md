...
1. In your tenant, create a client application to use authentication with `kubectl`:
   ...
   ![Create client application](/docs/guides/administer-shoots/images/create-client-application.webp)

1. Provide a *Name*, choose *Native* as application type, and choose *CREATE*.
   
   ![Choose application type](/docs/guides/administer-shoots/images/choose-application-type.webp)
...
1. In the tab *Settings*, copy the following parameters to a local text file:
   ...
   - *Client Secret*
     ...
     ![Basic information](/docs/guides/administer-shoots/images/basic-information.webp)
...
1. Configure the client to have a callback url of `http://localhost:8000`. This callback connects to your local `kubectl oidc-login` plugin:
   ...
   ![Configure callback](/docs/guides/administer-shoots/images/configure-callback.webp)
...
1. Choose *Users & Roles* \> *Users* \> *CREATE USERS* to create a user with a user and password:
   ...
   ![Create user](/docs/guides/administer-shoots/images/create-user.webp)
...
1. Enter your login credentials.
   ...
   ![Login through identity provider](/docs/guides/administer-shoots/images/login-through-identity-provider.webp)
