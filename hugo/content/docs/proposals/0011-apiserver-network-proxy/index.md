...
github_subdir: geps/0011-apiserver-network-proxy
params:
  github_branch: main
path_base_for_github_subdir:
  from: content/docs/proposals/0011-apiserver-network-proxy/README.md
  to: README.md
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/enhancements/blob/main/geps/0011-apiserver-network-proxy/README.md
-->


# GEP-0011: Utilize API Server Network Proxy to Invert Seed-to-Shoot Connectivity

- [GEP-0011: Utilize API Server Network Proxy to Invert Seed-to-Shoot Connectivity](#gep-0011-utilize-api-server-network-proxy-to-invert-seed-to-shoot-connectivity)
  - [Problem](#problem)
  - [Proposal](#proposal)
...
1. Use one proxy server for all agents.
...
- For directing traffic to the correct proxy-server, we will re-use the SNI proxy along with the load-balancer from [the shoot API server via SNI GEP](/docs/proposals/0008-shoot-apiserver-via-sni/).
