...
github_subdir: geps/0014-reversed-cluster-vpn
params:
  github_branch: main
path_base_for_github_subdir:
  from: content/docs/proposals/0014-reversed-cluster-vpn/README.md
  to: README.md
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/enhancements/blob/main/geps/0014-reversed-cluster-vpn/README.md
-->
...
![alt text](/docs/proposals/0014-reversed-cluster-vpn/currentclustervpn.png "Overview Current Cluster VPN")
...
![alt text](/docs/proposals/0014-reversed-cluster-vpn/reversedtunnelvpn.png "Reversed Tunnel VPN")
...
The `vpn-shoot-client` pod connects to the correct `vpn-seed-server` service via the SNI passthrough proxy introduced with [SNI Passthrough proxy for kube-apiservers](/docs/proposals/0008-shoot-apiserver-via-sni/) on port 8132.
...
![alt text](/docs/proposals/0014-reversed-cluster-vpn/wireguardclustervpn.png "Overview WireGuard Current Cluster VPN")
...
1. There is an option in OpenVPN to specify a tcp proxy as part of the endpoint configuration.
