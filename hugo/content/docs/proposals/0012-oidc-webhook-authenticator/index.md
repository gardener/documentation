...
github_subdir: geps/0012-oidc-webhook-authenticator
params:
  github_branch: main
path_base_for_github_subdir:
  from: content/docs/proposals/0012-oidc-webhook-authenticator/README.md
  to: README.md
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/enhancements/blob/main/geps/0012-oidc-webhook-authenticator/README.md
-->
...
![alt text](/docs/proposals/0012-oidc-webhook-authenticator/registration.svg "Authentication with OIDC webhook")
...
![alt text](/docs/proposals/0012-oidc-webhook-authenticator/authentication.svg "Authentication with OIDC webhook")
