...
github_subdir: geps/0021-ipv6-singlestack-local
params:
  github_branch: main
path_base_for_github_subdir:
  from: content/docs/proposals/0021-ipv6-singlestack-local/README.md
  to: README.md
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/enhancements/blob/main/geps/0021-ipv6-singlestack-local/README.md
-->
...
Hence, [e2e tests](https://github.com/gardener/gardener/tree/master/docs/development/testing.md#end-to-end-e2e-tests-using-provider-local) (presubmits and periodics) are added to prevent unnoticed regressions of the feature.
