...
github_subdir: geps/0035-observability2.0-victorialogs
params:
  github_branch: main
path_base_for_github_subdir:
  from: content/docs/proposals/0035-observability2.0-victorialogs/README.md
  to: README.md
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/enhancements/blob/main/geps/0035-observability2.0-victorialogs/README.md
-->
...
Since this document relies on work that has already been done in [GEP-34](/docs/proposals/0034-observability2.0-opentelemetry/), the same terminology applies here as well:
...
This document fully relies on [GEP-34](/docs/proposals/0034-observability2.0-opentelemetry/) having already been implemented.
...
One such advancement is [OTLP](https://opentelemetry.io/docs/specs/otel/protocol/), discussed in more detail in [GEP-34](/docs/proposals/0034-observability2.0-opentelemetry/).
...
See [GEP-34](/docs/proposals/0034-observability2.0-opentelemetry/) for more details.
