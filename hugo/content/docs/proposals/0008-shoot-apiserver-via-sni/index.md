...
github_subdir: geps/0008-shoot-apiserver-via-sni
params:
  github_branch: main
path_base_for_github_subdir:
  from: content/docs/proposals/0008-shoot-apiserver-via-sni/README.md
  to: README.md
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/enhancements/blob/main/geps/0008-shoot-apiserver-via-sni/README.md
-->


# GEP-0008: SNI Passthrough Proxy for kube-apiservers
