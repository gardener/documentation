...
github_subdir: geps/0001-gardener-extensibility
params:
  github_branch: main
path_base_for_github_subdir:
  from: content/docs/proposals/0001-gardener-extensibility/README.md
  to: README.md
...
After that we will take a look at the current [reconciliation](https://github.com/gardener/gardener/tree/master/pkg/gardenlet/controller/shoot/shoot/reconciler_reconcile.go)/[deletion](https://github.com/gardener/gardener/tree/master/pkg/gardenlet/controller/shoot/shoot/reconciler_delete.go) flow and describe how it would look like in case we would implement this proposal.
