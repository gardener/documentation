...
github_subdir: geps/0026-workload-identity
params:
  github_branch: main
path_base_for_github_subdir:
  from: content/docs/proposals/0026-workload-identity/README.md
  to: README.md
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/enhancements/blob/main/geps/0026-workload-identity/README.md
-->
...
[shoot quotas](https://github.com/gardener/gardener/tree/master/docs/concepts/apiserver.md#shoot-quotas) will be extended to also
...
[GEP-24](/docs/proposals/0024-shoot-oidc-issuer/), will be used to publish the public OIDC
