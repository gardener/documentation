...
github_subdir: geps/0020-ha-control-planes
params:
  github_branch: main
path_base_for_github_subdir:
  from: content/docs/proposals/0020-ha-control-planes/README.md
  to: README.md
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/enhancements/blob/main/geps/0020-ha-control-planes/README.md
-->
...
Enforcing that a highly available `ManagedSeed` is setup with odd number of zones, additional checks needs to be introduced in [admission plugin](https://github.com/gardener/gardener/tree/master/plugin/pkg/managedseed/validator/admission.go).
...
Today, after **Gardener Scheduler** has filtered candidates and applied the configured strategy, it chooses the seed with least scheduled shoots [ref](https://github.com/gardener/gardener/blob/b7e6d8691ccc9421a4cee73286497a1f004d5612/pkg/scheduler/controller/shoot/reconciler.go#L160).
...
1. Network connectivity to the machines running in an availability zone is either severely impacted or broken.
1. Subset of essential services (e.g. EBS volumes in case of AWS provider) are unhealthy, which might also have a cascading effect on other services.
1. Elevated API request failure rates when creating or updating infrastructure resources like machines, load balancers, etc.
...
> **Note:** A detailed network latency analysis can be viewed in the [Network Latency Analysis](/docs/other-components/etcd-druid/benchmark/etcd-network-latency/) topic.
...
<img src="/docs/proposals/0020-ha-control-planes/multi-zone-node-groups.png">
...
<img src="/docs/proposals/0020-ha-control-planes/activepassive-option1.png">
...
<img src="/docs/proposals/0020-ha-control-planes/activepassive-option2.png">
...
<img src="/docs/proposals/0020-ha-control-planes/singlezone-multinode.png" style="width:200px;height:250px">
...
_*Multiple zones & multiple nodes*

<img src="/docs/proposals/0020-ha-control-planes/multizone-multinode.png" style="width:450px;height:250px">
...
<img src="/docs/proposals/0020-ha-control-planes/etcdcluster-steadystate-traffic.png">
...
<img src="/docs/proposals/0020-ha-control-planes/put-request-targeting-leader.png"/>
...
<img src="/docs/proposals/0020-ha-control-planes/put-request-targeting-follower.png"/>
...
<img src="/docs/proposals/0020-ha-control-planes/etcd-member-initial-sync-with-large-revision.png"/>
...
<img src="/docs/proposals/0020-ha-control-planes/get-request-targeting-leader.png"/>
...
<img src="/docs/proposals/0020-ha-control-planes/get-request-targeting-follower.png"/>
...
root@etcd-client:/#
```
<img src="/docs/proposals/0020-ha-control-planes/delete-request-targeting-leader.png"/>
...
<img src="/docs/proposals/0020-ha-control-planes/delete-request-targeting-follower.png"/>
...
benchmark put --target-leader  --rate 500 --conns=400 --clients=800 --sequential-keys --key-starts 0 --val-size=1024 --total=100000 \
    ...
    --cert=/var/etcd/ssl/client/client/tls.crt
```
<img src="/docs/proposals/0020-ha-control-planes/watch-request-targeting-follower.png"/>
...
<img src="/docs/proposals/0020-ha-control-planes/watch-request-del-targeting-follower.png"/>
