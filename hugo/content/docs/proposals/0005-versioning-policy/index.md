...
github_subdir: geps/0005-versioning-policy
params:
  github_branch: main
path_base_for_github_subdir:
  from: content/docs/proposals/0005-versioning-policy/README.md
  to: README.md
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/enhancements/blob/main/geps/0005-versioning-policy/README.md
-->


# GEP-0005: Gardener Versioning Policy

Please refer to [this document](https://github.com/gardener/gardener/tree/master/docs/usage/shoot-operations/shoot_versions.md) for the documentation of the implementation of this GEP.
