...
path_base_for_github_subdir:
  from: content/docs/other-components/etcd-druid/deployment/configure-etcd-druid.md
  to: configure-etcd-druid.md
title: Configure Etcd Druid
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/etcd-druid/blob/master/docs/deployment/configure-etcd-druid.md
-->
...
Following set of flags configures the reconcilers running within etcd-druid. To know more about different reconcilers read [this](/contribute/other-components/etcd-druid/controllers/) document.
...
| Flag | Description | Default |
| --- | --- | --- |
| feature-gates | A set of key=value pairs that describe feature gates for alpha/experimental features. Please check [feature-gates](/docs/other-components/etcd-druid/deployment/feature-gates/) for more information. | "" |
