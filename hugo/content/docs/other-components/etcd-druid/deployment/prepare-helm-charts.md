...
path_base_for_github_subdir:
  from: content/docs/other-components/etcd-druid/deployment/prepare-helm-charts.md
  to: prepare-helm-charts.md
title: Prepare Helm Charts
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/etcd-druid/blob/master/docs/deployment/prepare-helm-charts.md
-->
...
| ApiVersion: admissionregistration.k8s.io/v1<br />Kind: ValidatingWebhookConfiguration | It is the validation webhook configuration. Currently there is only one webhook `etcdcomponents` . For more details see [here](/docs/other-components/etcd-druid/concepts/etcd-cluster-resource-protection/). |
