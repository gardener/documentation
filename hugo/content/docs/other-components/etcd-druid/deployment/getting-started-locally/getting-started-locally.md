...
github_subdir: docs/deployment/getting-started-locally
params:
  github_branch: master
path_base_for_github_subdir:
  from: >-
    content/docs/other-components/etcd-druid/deployment/getting-started-locally/getting-started-locally.md
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/etcd-druid/blob/master/docs/deployment/getting-started-locally/getting-started-locally.md
-->
...
Before we can setup `etcd-druid` and use it to provision `Etcd` clusters, we need to prepare the development environment. Follow the [Prepare Dev Environment Guide](/contribute/other-components/etcd-druid/prepare-dev-environment/) for detailed instructions.
...
| --- | --- |
| Azure Object Storage Emulator | [Manage Azurite](/docs/other-components/etcd-druid/deployment/getting-started-locally/manage-azurite-emulator/) (Steps 00-03) |
| S3 Object Store Emulator | [Manage LocalStack](/docs/other-components/etcd-druid/deployment/getting-started-locally/manage-s3-emulator/) (Steps 00-03) |
| GCS Object Store Emulator | [Manage GCS Emulator](/docs/other-components/etcd-druid/deployment/getting-started-locally/manage-gcs-emulator/) (Steps 00-03) |
...
We adhere to a naming convention for all resources that are provisioned for an `Etcd` cluster. Refer to [etcd-cluster-components](/docs/other-components/etcd-druid/concepts/etcd-cluster-components/) document to get details of all resources that are provisioned.
...
`Etcd` CR can be updated with new changes. To ensure that `etcd-druid` reconciles the changes you can refer to options that etcd-druid provides [here](/docs/other-components/etcd-druid/managing-etcd-clusters/#update--reconcile-an-etcd-cluster).
