...
path_base_for_github_subdir:
  from: content/docs/other-components/etcd-druid/deployment/feature-gates.md
  to: feature-gates.md
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/etcd-druid/blob/master/docs/deployment/feature-gates.md
-->
