...
path_base_for_github_subdir:
  from: content/docs/other-components/etcd-druid/managing-etcd-clusters.md
  to: managing-etcd-clusters.md
persona: Users
title: Managing Etcd Clusters
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/etcd-druid/blob/master/docs/usage/managing-etcd-clusters.md
-->
...
* You can additional monitor [all etcd cluster resources](/docs/other-components/etcd-druid/concepts/etcd-cluster-components/) that are created for every etcd cluster.
...
> For a complete list of CLI args you can see [this](/docs/other-components/etcd-druid/deployment/configure-etcd-druid/) document.
...
`etcd` cluster resources are managed by `etcd-druid` and since v0.23.0 version of `etcd-druid` any changes to these managed resources are protected via a validating webhook. You can find more information about this webhook [here](/docs/other-components/etcd-druid/concepts/etcd-cluster-resource-protection/). To be able to manually modify etcd cluster managed resources two things needs to be done:
