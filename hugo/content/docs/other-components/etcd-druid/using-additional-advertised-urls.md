...
path_base_for_github_subdir:
  from: content/docs/other-components/etcd-druid/using-additional-advertised-urls.md
  to: using-additional-advertised-urls.md
persona: Users
title: Using Additional Advertised Urls
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/etcd-druid/blob/master/docs/usage/using-additional-advertised-urls.md
-->
