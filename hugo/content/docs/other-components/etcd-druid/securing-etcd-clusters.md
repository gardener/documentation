...
path_base_for_github_subdir:
  from: content/docs/other-components/etcd-druid/securing-etcd-clusters.md
  to: securing-etcd-clusters.md
persona: Users
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/etcd-druid/blob/master/docs/usage/securing-etcd-clusters.md
-->
...
<img src="/docs/other-components/etcd-druid/assets/images/tls-communication-lines.excalidraw.png" alt="communication-lines" style="width:1200px;">
...
SAN check can be disabled by setting `spec.etcd.peerUrlTls.skipClientSANVerification` to `true`:
