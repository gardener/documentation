...
path_base_for_github_subdir:
  from: >-
    content/docs/other-components/etcd-druid/proposals/03-scaling-up-an-etcd-cluster.md
  to: 03-scaling-up-an-etcd-cluster.md
title: 03 Scaling Up An Etcd Cluster
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/etcd-druid/blob/master/docs/proposals/03-scaling-up-an-etcd-cluster.md
-->
...
1. Providing the correct configuration to start new etcd members as it is different from boostrapping a cluster since these new etcd members will join an existing cluster.
...
1. In case the peer URL TLS has been changed to `enabled`: Etcd-druid will add tasks to the deployment flow:
...
![Sequence diagram](/docs/other-components/etcd-druid/proposals/assets/03-scale-up-sequencediagram.png)
