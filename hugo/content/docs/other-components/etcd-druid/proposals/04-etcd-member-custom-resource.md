...
path_base_for_github_subdir:
  from: >-
    content/docs/other-components/etcd-druid/proposals/04-etcd-member-custom-resource.md
  to: 04-etcd-member-custom-resource.md
reviewers:
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/etcd-druid/blob/master/docs/proposals/04-etcd-member-custom-resource.md
-->
...
<img title="" src="/docs/other-components/etcd-druid/proposals/assets/04-top-level-state-transitions.excalidraw.png" alt="" data-align="center">
...
<img title="" src="/docs/other-components/etcd-druid/proposals/assets/04-state-transitions-bootstrap-0-1.excalidraw.png" alt="" data-align="center">
...
<img title="" src="/docs/other-components/etcd-druid/proposals/assets/04-state-transitions-scaleup-1-n.excalidraw.png" alt="" data-align="center">
...
<img title="" src="/docs/other-components/etcd-druid/proposals/assets/04-state-transitions-restart-member.excalidraw.png" alt="" data-align="center">
...
1. backup-sidecar attempts to fetch etcd cluster member-list and checks if this etcd-member is already part of the cluster.

1. Size of the cluster by checking `initial-cluster` in the etcd config.
...
1. Scale down of an etcd cluster to 0 replicas due to hibernation of the k8s control plane.

1. Transient scale down of an etcd cluster to 0 replicas to recover from a quorum loss.
