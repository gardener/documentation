...
path_base_for_github_subdir:
  from: content/docs/other-components/machine-controller-manager/proposals/_index.md
  to: _index.md
persona: Developers
title: Proposals
weight: 3
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/machine-controller-manager/blob/master/docs/proposals/_index.md
-->
