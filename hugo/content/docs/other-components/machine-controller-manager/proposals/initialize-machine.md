...
path_base_for_github_subdir:
  from: >-
    content/docs/other-components/machine-controller-manager/proposals/initialize-machine.md
  to: initialize-machine.md
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/machine-controller-manager/blob/master/docs/proposals/initialize-machine.md
-->
...
1. We have a need for "machine-instance-not-ready" taint as described in [MCM#740](https://github.com/gardener/machine-controller-manager/issues/740) which should only get removed once the post creation updates are finished.
...
1. We will introduce a new *machine operation* stage `InstanceInitialization`. In case of an `codes.Initialization` error
...
![Enhanced triggerCreationFlow](/docs/other-components/machine-controller-manager/proposals/initialize-machine-triggercreationflow.svg)
...
Kindly refer to the [Hot-Update Instances](/docs/other-components/machine-controller-manager/proposals/hotupdate-instances/) design which provides elaborate detail.
