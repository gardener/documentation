...
path_base_for_github_subdir:
  from: >-
    content/docs/other-components/machine-controller-manager/machine_deployment.md
  to: machine_deployment.md
persona: Operators
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/machine-controller-manager/blob/master/docs/operations/machine_deployment.md
-->
...
Health monitor is also applied similar to how it's described for [machine-sets](/docs/other-components/machine-controller-manager/machine_set/)
