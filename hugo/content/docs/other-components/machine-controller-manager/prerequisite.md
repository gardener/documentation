...
path_base_for_github_subdir:
  from: content/docs/other-components/machine-controller-manager/prerequisite.md
  to: prerequisite.md
persona: Operators
title: Prerequisite
prev: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/machine-controller-manager/blob/master/docs/operations/prerequisite.md
-->
...
> Run the Machine Controller Manager either as described in [Setting up a local development environment](/contribute/other-components/machine-controller-manager/local_setup/) or [Deploying the Machine Controller Manager into a Kubernetes cluster](/docs/other-components/machine-controller-manager/deployment/).
