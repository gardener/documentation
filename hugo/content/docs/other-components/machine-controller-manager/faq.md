...
path_base_for_github_subdir:
  from: content/docs/other-components/machine-controller-manager/faq.md
  to: faq.md
persona: Operators
title: FAQ
weight: 5
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/machine-controller-manager/blob/master/docs/faq.md
-->
...
This mode is used for provisioning control plane machines of [autonomous shoot clusters](/docs/gardener/deployment/getting_started_locally_with_gardenadm/) (`gardenadm bootstrap` command, medium-touch scenario).
...
Please refer the following [document](/docs/other-components/machine-controller-manager/#design-of-machine-controller-manager).
...
![image](/docs/other-components/machine-controller-manager/images/machine_phase_transition.png)
...
In gardener context however, [DWD](/docs/other-components/dependency-watchdog/concepts/prober/#origin) is deployed to deal with this scenario, but to stay protected from corner cases, this mechanism has been introduced in MCM.
...
- Developer can locally setup the MCM using following [guide](/contribute/other-components/machine-controller-manager/local_setup/)
...
- Developer can locally run [integration tests](/contribute/other-components/machine-controller-manager/integration_tests/) to ensure basic functionality of MCM is not altered.
