...
github_subdir: docs/documents
params:
  github_branch: master
path_base_for_github_subdir:
  from: content/docs/other-components/machine-controller-manager/documents/apis.md
  to: apis.md
title: Apis
prev: false
next: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/machine-controller-manager/blob/master/docs/documents/apis.md
-->
...
<script setup>
const apiHtml = `<h3 id="machine.sapcloud.io/v1alpha1.Machine">
<b>Machine</b>
</h3>
<p>
