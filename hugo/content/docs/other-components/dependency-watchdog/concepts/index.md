...
path_base_for_github_subdir:
  from: content/docs/other-components/dependency-watchdog/concepts/_index.md
  to: _index.md
persona: Developers
title: Concepts
weight: 2
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/dependency-watchdog/blob/master/docs/concepts/_index.md
-->
