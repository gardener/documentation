...
path_base_for_github_subdir:
  from: content/docs/gardener/api-reference/operations.md
  to: operations.md
title: Operations
prev: false
next: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/api-reference/operations.md
-->
...
<td>
<em>(Optional)</em>
<p>SeedName is the name of the seed to which this Bastion is currently scheduled. This field is populated<br />at the beginning of a create/reconcile operation.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<em>(Optional)</em>
<p>LastHeartbeatTimestamp is the time when the bastion was last marked as<br />not to be deleted. When this is set, the ExpirationTimestamp is advanced<br />as well.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<em>(Optional)</em>
<p>ExpirationTimestamp is the time after which a Bastion is supposed to be<br />garbage collected.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<em>(Optional)</em>
<p>ObservedGeneration is the most recent generation observed for this Bastion. It corresponds to the<br />Bastion's generation, which is updated on mutation by the API Server.</p>
</td>
</tr>
