...
path_base_for_github_subdir:
  from: content/docs/gardener/api-reference/core.md
  to: core.md
title: Core
prev: false
next: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/api-reference/core.md
-->
...
Deprecated: Use CredentialsBinding instead. See /docs/gardener/shoot-operations/secretbinding-to-credentialsbinding-migration/ for migration instructions.
</p>
...
Deprecated: Use CredentialsBindingProvider instead. See /docs/gardener/shoot-operations/secretbinding-to-credentialsbinding-migration/ for migration instructions.
</p>
