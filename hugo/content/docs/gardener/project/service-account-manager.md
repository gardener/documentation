---
aliases:
  - /docs/gardener/service-account-manager/
...
path_base_for_github_subdir:
  from: content/docs/gardener/project/service-account-manager.md
  to: service-account-manager.md
persona: Users
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/usage/project/service-account-manager.md
-->
