...
path_base_for_github_subdir:
  from: content/docs/gardener/overlapping-network-ranges.md
  to: overlapping-network-ranges.md
persona: Operators
title: Overlapping Network Ranges
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/operations/overlapping-network-ranges.md
-->
...
![double-nat](/docs/gardener/images/double-nat.png)
...
and thus cannot be used as shoot ranges. You can find the specific ranges in the [user networking guide](/docs/gardener/networking/shoot_networking/#reserved-networks)
...
### HA Shoots
[HA shoots](/docs/guides/high-availability/control-plane/) deploy two VPN servers as a StatefulSet. The Kube API server is connected directly to the VPN network via two VPN clients, one for each VPN server.
