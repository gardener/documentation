...
path_base_for_github_subdir:
  from: content/docs/gardener/extensions/referenced-resources.md
  to: referenced-resources.md
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/extensions/referenced-resources.md
-->
