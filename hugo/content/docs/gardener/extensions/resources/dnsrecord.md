...
path_base_for_github_subdir:
  from: content/docs/gardener/extensions/resources/dnsrecord.md
  to: dnsrecord.md
title: DNS Record
prev: false
next: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/extensions/resources/dnsrecord.md
-->
...
* The naming used by other provider-specific extension controllers, e.g., for [infrastructure](/docs/gardener/extensions/resources/infrastructure/). For example, on AWS the key names are `accessKeyId`, `secretAccessKey`, and `region`.
...
They are part of the [`Cluster` extension resource](/docs/gardener/extensions/cluster/) and can be used to extract information that is not part of the `DNSRecord` resource itself.
...
* [`DNSRecord` API (Golang specification)](https://github.com/gardener/gardener/blob/master/pkg/apis/extensions/v1alpha1/types_dnsrecord.go)
