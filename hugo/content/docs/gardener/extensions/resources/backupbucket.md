...
path_base_for_github_subdir:
  from: content/docs/gardener/extensions/resources/backupbucket.md
  to: backupbucket.md
title: BackupBucket
prev: false
next: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/extensions/resources/backupbucket.md
-->
...
* [`BackupBucket` API Reference](/docs/gardener/api-reference/extensions/#backupbucket)
...
* [`BackupEntry` Resource Documentation](/docs/gardener/extensions/resources/backupentry/)
