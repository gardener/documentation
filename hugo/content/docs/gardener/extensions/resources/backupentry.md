...
path_base_for_github_subdir:
  from: content/docs/gardener/extensions/resources/backupentry.md
  to: backupentry.md
title: BackupEntry
prev: false
next: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/extensions/resources/backupentry.md
-->
...
* [`BackupEntry` API Reference](/docs/gardener/api-reference/extensions/#backupbucket)
...
* [`BackupBucket` Resource Documentation](/docs/gardener/extensions/resources/backupbucket/)
* [Shared Bucket Proposal](https://github.com/gardener/enhancements/tree/main/geps/0002-backup-infrastructure)
* [Gardener-controller-manager-component-config API Specification](https://github.com/gardener/gardener/blob/master/pkg/apis/config/controllermanager/v1alpha1/types.go)
