...
path_base_for_github_subdir:
  from: content/docs/gardener/extensions/resources/selfhostedshootexposure.md
  to: selfhostedshootexposure.md
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/extensions/resources/selfhostedshootexposure.md
-->
...
1. Provisioning a load balancer (or similar mechanism) that accepts traffic on `.spec.port` and routes traffic to the listed control plane endpoints.
1. Updating the `.status.ingress` field with the public address (IP or hostname) of the provisioned load balancer.
...
* [SelfHostedShootExposure API Documentation](https://github.com/gardener/gardener/blob/master/pkg/apis/extensions/v1alpha1/types_selfhostedshootexposure.go)
