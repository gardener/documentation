...
path_base_for_github_subdir:
  from: content/docs/gardener/extensions/resources/network.md
  to: network.md
title: Network
prev: false
next: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/extensions/resources/network.md
-->
...
The spec of above resources is divided into two parts (more information can be found at [Using the Networking Calico Extension](/docs/extensions/network-extensions/gardener-extension-networking-calico/usage/)):
