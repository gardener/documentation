...
path_base_for_github_subdir:
  from: content/docs/gardener/extensions/resources/extension.md
  to: extension.md
title: Extension
prev: false
next: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/extensions/resources/extension.md
-->
...
Gardener creates Extension resources as part of the Shoot reconciliation. Moreover, it is guaranteed that the [Cluster](/docs/gardener/extensions/cluster/) resource exists before the `Extension` resource is created. `Extension`s can be reconciled at different stages during Shoot reconciliation depending on the defined extension lifecycle strategy in the respective `ControllerRegistration` resource. Please consult the [Extension Lifecycle](/docs/gardener/extensions/registration/#extension-lifecycle) section for more information.
