...
path_base_for_github_subdir:
  from: content/docs/gardener/extensions/resources/controlplane.md
  to: controlplane.md
title: ControlPlane
prev: false
next: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/extensions/resources/controlplane.md
-->
...
As mentioned in the [controlplane customization webhooks](/docs/gardener/extensions/controlplane-webhooks/) document, Gardener shall not deploy any `cloud-controller-manager` or any other provider-specific component.
...
The second one contains the output of the [`Infrastructure` resource](/docs/gardener/extensions/resources/infrastructure/) (that might be relevant for the CCM config).
...
For more information, see [`NetworkPolicy`s In Garden, Seed, Shoot Clusters](/docs/gardener/network_policies/).
