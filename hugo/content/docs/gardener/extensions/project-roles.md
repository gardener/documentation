...
path_base_for_github_subdir:
  from: content/docs/gardener/extensions/project-roles.md
  to: project-roles.md
title: Project Roles
prev: false
next: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/extensions/project-roles.md
-->
...
Please consult [Projects](/docs/gardener/project/projects/) for further information.
