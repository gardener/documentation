...
path_base_for_github_subdir:
  from: content/docs/gardener/extensions/shoot-health-status-conditions.md
  to: shoot-health-status-conditions.md
title: Shoot Health Status Conditions
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/extensions/shoot-health-status-conditions.md
-->
...
This can be accomplished using the [health check library for extensions](/docs/gardener/extensions/healthcheck-library/).
