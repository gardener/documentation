...
path_base_for_github_subdir:
  from: content/docs/gardener/extensions/validation-guidelines-for-extensions.md
  to: validation-guidelines-for-extensions.md
title: Validation Guidelines For Extensions
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/extensions/validation-guidelines-for-extensions.md
-->
...
For this purpose, the extension library leverages the `ConfigValidator` interfaces (e.g. see the [`ConfigValidator` interface for Infrastructure](/docs/gardener/extensions/resources/infrastructure/#configvalidator-interface)).
...
For more details, see [Referenced Resources](/docs/gardener/extensions/referenced-resources/).
...
- [`ExtensionLabels` admission plugin](/docs/gardener/concepts/apiserver-admission-plugins/#extensionlabels) ensures that `WorkloadIdentity`s have the label `provider.extensions.gardener.cloud/<type>: "true"`, therefore extension admission components should make use of this label via `objectSelector` to admit only the `WorkloadIdentity`s of their type.
...
- Webhooks of extension admission components should use `objectSelector` to filter only requests for resources that use the extension.
  - The extension admission components should use the extension-specific labels maintained on the API resources by the [`ExtensionLabels` admission plugin](/docs/gardener/concepts/apiserver-admission-plugins/#extensionlabels).
- See the [General Guidelines for Gardener core components](/contribute/developer-starter-kit/validation-guidelines/#general-guidelines).
