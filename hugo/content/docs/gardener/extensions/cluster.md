...
path_base_for_github_subdir:
  from: content/docs/gardener/extensions/cluster.md
  to: cluster.md
title: Cluster
prev: false
next: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/extensions/cluster.md
-->
...
These extensions often serve a well-defined purpose (e.g., the management of [DNS records](/docs/gardener/extensions/resources/dnsrecord/), [infrastructure](/docs/gardener/extensions/resources/infrastructure/)).
...
> [!NOTE]
> The `.spec.seed` field is optional and not set for self-hosted shoots (see [GEP-28](https://github.com/gardener/gardener/blob/master/docs/proposals/28-self-hosted-shoot-clusters.md)).
...
For example, if the [managed ingress controller](/docs/gardener/deployment/deploy_gardenlet_manually/) is active on the seed, Gardener will create a [DNSRecord](/docs/gardener/extensions/resources/dnsrecord/) resource(s) in the `garden` namespace of the seed cluster for the ingress DNS record.
