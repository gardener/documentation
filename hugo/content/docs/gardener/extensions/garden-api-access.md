...
For this, `gardenlet` runs an instance of the [`TokenRequestor`](/docs/gardener/concepts/gardenlet/#tokenrequestor-controller) for requesting tokens that can be used to communicate with the garden cluster.
