---
aliases:
  - /docs/gardener/control-plane-endpoints-and-ports/
github_repo: 'https://github.com/gardener/gardener'
github_subdir: docs/usage/advanced
params:
  github_branch: master
path_base_for_github_subdir:
  from: content/docs/gardener/advanced/control-plane-endpoints-and-ports.md
  to: control-plane-endpoints-and-ports.md
persona: Users
title: Control Plane Endpoints And Ports
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/usage/advanced/control-plane-endpoints-and-ports.md
-->


# Endpoints and Ports of a Shoot Control-Plane

With the [reversed VPN](/contribute/gardener/reversed-vpn-tunnel/) tunnel, there are no endpoints with open ports in the shoot cluster required by Gardener.
...
Depending on the configured zones or [exposure classes](/docs/gardener/networking/exposureclasses/), there are different endpoints in a seed cluster. The IP address(es) can be determined by a DNS query for the API Server URL.
...
![kube-apiserver via SNI](/docs/gardener/advanced/images/api-server-sni.png)
...
![apiserver-proxy](/docs/gardener/advanced/images/api-server-proxy.png)
...
![Reversed VPN](/docs/gardener/advanced/images/reversed-vpn.png)
...
More details can be found in the [usage document](/contribute/gardener/reversed-vpn-tunnel/) and [GEP-0014](https://github.com/gardener/enhancements/tree/main/geps/0014-reversed-cluster-vpn).
