---
aliases:
  - /docs/gardener/containerd-registry-configuration/
github_repo: 'https://github.com/gardener/gardener'
github_subdir: docs/usage/advanced
params:
  github_branch: master
path_base_for_github_subdir:
  from: content/docs/gardener/advanced/containerd-registry-configuration.md
  to: containerd-registry-configuration.md
persona: Users
...
For more details, see the [registry-cache documentation](/docs/extensions/others/gardener-extension-registry-cache/).
