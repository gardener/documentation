...
path_base_for_github_subdir:
  from: content/docs/gardener/topology_aware_routing.md
  to: topology_aware_routing.md
persona: Operators
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/operations/topology_aware_routing.md
-->
...
Layer 7 load-balancing is active when `IstioTLSTermination` feature gate is active on the Seed and the Shoot did not opt out. Please see this [documentation](/docs/gardener/kube_apiserver_loadbalancing/) for more details.
...
Layer 7 load-balancing is active when `IstioTLSTermination` feature gate is active in `gardener-operator`. Please see this [documentation](/docs/gardener/kube_apiserver_loadbalancing/) for more details.
