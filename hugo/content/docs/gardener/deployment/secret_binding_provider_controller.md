...
path_base_for_github_subdir:
  from: content/docs/gardener/deployment/secret_binding_provider_controller.md
  to: secret_binding_provider_controller.md
title: Secret Binding Provider Controller
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/deployment/secret_binding_provider_controller.md
-->
...
1. Disable the SecretBinding provider controller and enable the `SecretBindingProviderValidation` feature gate of Gardener API server.
