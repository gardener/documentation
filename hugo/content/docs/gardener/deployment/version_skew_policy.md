...
path_base_for_github_subdir:
  from: content/docs/gardener/deployment/version_skew_policy.md
  to: version_skew_policy.md
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/deployment/version_skew_policy.md
-->
...
For more information, see the [Releases document](/contribute/gardener/process/#releases).
...
Please also take a look at the [Gardener upgrade guide](/docs/gardener/upgrade-gardener/).
...
However, since all extensions typically make use of the [extensions library](https://github.com/gardener/gardener/tree/master/extensions) ([example](https://github.com/gardener/gardener-extension-provider-aws/blob/cb96b60c970c2e20615dffb3018dc0571cab764d/go.mod#L12)), a general constraint is that *no extension must depend on a version of the extensions library higher than the version of `gardenlet`*.
...
Please refer to [Supported Kubernetes Versions](/docs/gardener/shoot-operations/supported_k8s_versions/).
