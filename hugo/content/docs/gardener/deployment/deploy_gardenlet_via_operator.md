...
path_base_for_github_subdir:
  from: content/docs/gardener/deployment/deploy_gardenlet_via_operator.md
  to: deploy_gardenlet_via_operator.md
title: Deploy Gardenlet Via Operator
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/deployment/deploy_gardenlet_via_operator.md
-->
...
Using this method only works when [`gardener-operator`](/docs/gardener/concepts/operator/) is managing the garden cluster.
...
Once running, the gardenlet leverages the [self-upgrade](/docs/gardener/deployment/deploy_gardenlet_manually/#self-upgrades) strategy in order to keep itself up-to-date.
...
Once it comes up, gardenlet will create a `Seed` resource with the same name and uses the `Gardenlet` resource for self-upgrades (see [this document](/docs/gardener/deployment/deploy_gardenlet_manually/#self-upgrades)).
