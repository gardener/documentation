...
path_base_for_github_subdir:
  from: content/docs/gardener/deployment/setup_gardener.md
  to: setup_gardener.md
title: Setup Gardener
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/deployment/setup_gardener.md
-->
...
In this setup, the very first `Seed` will be reserved for one or several "infrastructure" `Shoot`s. Those will be turned into `Seed`s again through a `ManagedSeed` resource. These **Gardener-managed** `Seed`s will then host control planes of any users' `Shoot` clusters.

![Gardener Setup](/docs/gardener/deployment/content/gardener-setup.png)
...
- [Gardener Configuration](/docs/gardener/configuration/#system-configuration)
- [DNS records](/docs/gardener/extensions/resources/dnsrecord/)
...
- [Gardener extensibility](/docs/gardener/#extensions)
...
- at least one [infrastructure provider](/docs/extensions/#infrastructure-provider) (commonly referred to as provider-extension)
- at least one [operating system extension](/docs/extensions/#operating-system) - [Garden Linux](https://github.com/gardener/gardener-extension-os-gardenlinux) is recommended
- at least one [network plugin (CNI)](/docs/extensions/#network-plugin)
- Shoot services
...
Check the [extension registration documentation](/docs/gardener/extensions/registration/) for more details.
...
![extensions](/docs/gardener/deployment/content/extensions.png)
...
> See [Helm Chart Image Vector](/docs/gardener/deployment/image_vector/#helm-chart-image-vector) for details.
...
To further simplify both installation and operations, it is recommended to deploy the certificate service extension to the runtime cluster as well. Follow this [example](https://github.com/gardener/gardener-extension-shoot-cert-service/blob/master/example/extension.yaml) to add a default issuer to the runtime cluster and request the extension to be deployed to where needed. Next, expand the `Garden` resource's [configuration](/docs/extensions/others/gardener-extension-shoot-cert-service/deployment/#providing-trusted-tls-certificate-for-garden-runtime-cluster) to use the extension:
...
![Garden](/docs/gardener/deployment/content/garden.png)
...
To obtain credentials and interact with the virtual Garden cluster, please follow this [guide](/docs/gardener/concepts/operator/#virtual-garden-kubeconfig).
...
- [Configuration options](/docs/gardener/concepts/operator/#garden-resources)
- [Accessing the virtual Garden](/docs/gardener/concepts/operator/#virtual-garden-kubeconfig)
...
- [`CloudProfile`s](/docs/gardener/concepts/apiserver/#cloudprofiles)
- [`CloudProfile` example](https://github.com/gardener/gardener/blob/master/example/30-cloudprofile.yaml)
- [OpenStack `CloudProfile` example](/docs/extensions/infrastructure-extensions/gardener-extension-provider-openstack/operations/)
- [Garden Linux release notes example](https://github.com/gardenlinux/gardenlinux/releases/tag/1592.3)
- [Image vector](/docs/gardener/deployment/image_vector/)
...
> [!IMPORTANT]
> The preferred way to configure domain settings is by explicitly setting them through the [`Seed` API](https://github.com/gardener/gardener/blob/master/example/50-seed.yaml):
...
- [`DNSRecord`s](/docs/gardener/extensions/resources/dnsrecord/#what-does-gardener-create-dns-records-for)
...
![gardenlet](/docs/gardener/deployment/content/gardenlet.png)
...
- [Gardenlet documentation](/docs/gardener/concepts/gardenlet/)
- [Deploying a Gardenlet](/docs/gardener/deployment/deploy_gardenlet/)
...
![managed seed](/docs/gardener/deployment/content/managedseed.png)

Reference documentation:

- [Managed Seeds](/docs/gardener/managed_seed/)
