...
path_base_for_github_subdir:
  from: content/docs/gardener/deployment/configuring_logging.md
  to: configuring_logging.md
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/deployment/configuring_logging.md
-->
