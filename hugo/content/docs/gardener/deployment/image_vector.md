...
path_base_for_github_subdir:
  from: content/docs/gardener/deployment/image_vector.md
  to: image_vector.md
title: Image Vector
prev: false
next: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/deployment/image_vector.md
-->
...
The image repositories and tags are defined in a [central image vector file](https://github.com/gardener/gardener/blob/master/imagevector/containers.yaml).
