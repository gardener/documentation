---
aliases:
  - /docs/gardener/shoot_autoscaling/
...
path_base_for_github_subdir:
  from: content/docs/gardener/autoscaling/shoot_autoscaling.md
  to: shoot_autoscaling.md
persona: Users
title: Shoot Autoscaling
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/usage/autoscaling/shoot_autoscaling.md
-->
...
This document provides an overview of these scenarios and how the respective auto-scaling components can be enabled and configured. For more details, please see our [pod auto-scaling best practices](/docs/guides/applications/shoot-pod-autoscaling-best-practices/).
...
There are [general options for `cluster-autoscaler`](/docs/gardener/api-reference/core/#clusterautoscaler), and these values will be used for all worker groups except for those overwriting them. Additionally, there are some [`cluster-autoscaler` flags to be set per worker pool](/docs/gardener/api-reference/core/#clusterautoscaleroptions). They override any general value such as those specified in the general flags above.
...
The `Shoot` API allows to configure most of the [flags of the `horizontal-pod-autoscaler`](/docs/gardener/api-reference/core/#horizontalpodautoscalerconfig).
...
The `Shoot` API allows to configure a few [flags of the `vertical-pod-autoscaler`](/docs/gardener/api-reference/core/#verticalpodautoscaler).
...
Please continue reading our [pod auto-scaling best practices](/docs/guides/applications/shoot-pod-autoscaling-best-practices/) for more details and recommendations.
