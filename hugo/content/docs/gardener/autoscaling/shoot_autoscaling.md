...
There are [general options for `cluster-autoscaler`](/docs/gardener/api-reference/core/#core.gardener.cloud/v1beta1.ClusterAutoscaler), and these values will be used for all worker groups except for those overwriting them. Additionally, there are some [`cluster-autoscaler` flags to be set per worker pool](/docs/gardener/api-reference/core/#core.gardener.cloud/v1beta1.ClusterAutoscalerOptions). They override any general value such as those specified in the general flags above.
...
The `Shoot` API allows to configure most of the [flags of the `horizontal-pod-autoscaler`](/docs/gardener/api-reference/core/#core.gardener.cloud/v1beta1.HorizontalPodAutoscalerConfig).
...
The `Shoot` API allows to configure a few [flags of the `vertical-pod-autoscaler`](/docs/gardener/api-reference/core/#core.gardener.cloud/v1beta1.VerticalPodAutoscaler).
