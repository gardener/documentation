...
path_base_for_github_subdir:
  from: content/docs/gardener/concepts/backup-restore.md
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/concepts/backup-restore.md
-->
...
## Bucket Provisioning
Refer to the [backup bucket extension document](/docs/gardener/extensions/resources/backupbucket/) to find out details about configuring the backup bucket.
