...
path_base_for_github_subdir:
  from: content/docs/gardener/concepts/gardenadm.md
  to: gardenadm.md
title: gardenadm
prev: false
next: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/concepts/gardenadm.md
-->
...
<img src="/docs/gardener/concepts/gardenadm-large.png" alt="gardenadm" width="100"/>
...
![Architectural overview](/docs/gardener/concepts/images/gardenadm-overview.png)
...
[This document](/docs/gardener/deployment/getting_started_locally_with_gardenadm/) walks you through deploying Self-Hosted Shoot Clusters using `gardenadm` on your local machine.
...
- Managed Infrastructure, meaning that there is programmable infrastructure available where we can leverage [provider extensions](/docs/extensions/#infrastructure-provider) and [`machine-controller-manager`](https://github.com/gardener/machine-controller-manager) in order to manage the network setup and the machines.
