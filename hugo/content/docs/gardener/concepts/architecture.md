...
path_base_for_github_subdir:
  from: content/docs/gardener/concepts/architecture.md
  to: architecture.md
title: Architecture
prev: false
next: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/concepts/architecture.md
-->
...
![Gardener Overview Architecture Diagram](/docs/gardener/concepts/images/gardener-architecture-overview.png)

## Detailed Architecture Diagram

![Gardener Detailed Architecture Diagram](/docs/gardener/concepts/images/gardener-architecture-detailed.png)
