...
path_base_for_github_subdir:
  from: content/docs/gardener/concepts/apiserver.md
  to: apiserver.md
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/concepts/apiserver.md
-->
...
Please see [this](https://github.com/gardener/gardener/blob/master/example/30-cloudprofile.yaml) example manifest and consult the documentation of your provider extension controller to get information about its `providerConfig`.
...
Please see [this](https://github.com/gardener/gardener/blob/master/example/35-namespacedcloudprofile.yaml) example manifest and [this](/docs/gardener/project/namespaced-cloud-profiles/) usage documentation for further information.
...
Please see [this](https://github.com/gardener/gardener/blob/master/example/45-secret-seed-backup.yaml), [this](https://github.com/gardener/gardener/blob/master/example/50-seed.yaml), and optionally [this](https://github.com/gardener/gardener/blob/master/example/40-secret-seed.yaml) example manifests.
...
Please see [this](https://github.com/gardener/gardener/blob/master/example/60-quota.yaml) example manifest.
...
Please see [this](https://github.com/gardener/gardener/blob/master/example/05-project-dev.yaml) example manifest.

## `SecretBinding`s

Now that the end-user has a namespace the next step is registering their infrastructure provider account.

Please see [this](https://github.com/gardener/gardener/blob/master/example/70-secret-provider.yaml) example manifest and consult the documentation of the extension controller for the respective infrastructure provider to get information about which keys are required in this secret.
...
Please see [this](https://github.com/gardener/gardener/blob/master/example/80-secretbinding.yaml) example manifest.
...
Please see [this](https://github.com/gardener/gardener/blob/master/example/90-shoot.yaml) example manifest and consult the documentation of the provider extension controller to get information about its `spec.provider.controlPlaneConfig`, `.spec.provider.infrastructureConfig`, and `.spec.provider.workers[].providerConfig`.

## Overview Data Model

![Gardener Overview Data Model](/docs/gardener/concepts/images/gardener-data-model-overview.png)
