---
aliases:
  - /docs/gardener/exposureclasses/
github_repo: 'https://github.com/gardener/gardener'
github_subdir: docs/usage/networking
params:
  github_branch: master
path_base_for_github_subdir:
  from: content/docs/gardener/networking/exposureclasses.md
  to: exposureclasses.md
persona: Users
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/usage/networking/exposureclasses.md
-->
...
- If there are Seeds with matching labels for the seed selector, then the Shoot will be assigned to the best candidate after the scheduling strategy is applied, see [Gardener Scheduler](/docs/gardener/concepts/scheduler/#algorithm-overview).
