---
aliases:
  - /docs/gardener/shoot_kubernetes_service_host_injection/
github_repo: 'https://github.com/gardener/gardener'
github_subdir: docs/usage/networking
params:
  github_branch: master
path_base_for_github_subdir:
  from: content/docs/gardener/networking/shoot_kubernetes_service_host_injection.md
  to: shoot_kubernetes_service_host_injection.md
persona: Users
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/usage/networking/shoot_kubernetes_service_host_injection.md
-->


# `KUBERNETES_SERVICE_HOST` Environment Variable Injection

In each Shoot cluster's `kube-system` namespace a `DaemonSet` called `apiserver-proxy` is deployed. It routes traffic to the upstream Shoot Kube APIServer. See the [APIServer SNI GEP](https://github.com/gardener/enhancements/tree/main/geps/0008-shoot-apiserver-via-sni) for more details.
