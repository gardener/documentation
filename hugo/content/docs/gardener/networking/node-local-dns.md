---
aliases:
  - /docs/gardener/node-local-dns/
github_repo: 'https://github.com/gardener/gardener'
github_subdir: docs/usage/networking
params:
  github_branch: master
path_base_for_github_subdir:
  from: content/docs/gardener/networking/node-local-dns.md
  to: node-local-dns.md
persona: Users
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/usage/networking/node-local-dns.md
-->
...
![node-local-dns-architecture](/docs/gardener/networking/images/node-local-dns.png)
...
- Enabling or disabling node-local-dns triggers a rollout of all shoot worker nodes, see also [this document](/docs/gardener/shoot-operations/shoot_updates/#rolling-update-triggers).
...
Please refer to [Custom DNS Configuration](/docs/gardener/networking/custom-dns-config/#node-local-dns).
