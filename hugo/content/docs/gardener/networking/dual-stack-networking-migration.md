---
aliases:
  - /docs/gardener/dual-stack-networking-migration/
...
path_base_for_github_subdir:
  from: content/docs/gardener/networking/dual-stack-networking-migration.md
  to: dual-stack-networking-migration.md
persona: Users
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/usage/networking/dual-stack-networking-migration.md
-->
...
```
For more information, please refer to the [manual worker pool rollout](/docs/gardener/shoot-operations/worker_pool_manual_rollout/) documentation.
