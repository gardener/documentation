...
path_base_for_github_subdir:
  from: content/docs/gardener/kube_apiserver_loadbalancing.md
  to: kube_apiserver_loadbalancing.md
persona: Operators
title: Kube Apiserver Loadbalancing
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/operations/kube_apiserver_loadbalancing.md
-->


# Kube API server load balancing

Load balancing for shoot and garden Kube API servers leverages the [Gardener Istio deployment](/docs/gardener/istio/).

In default mode Istio performs L4 load balancing. Istio distributes connections to Kube API servers preferably in the
same zone ([Topology-Aware Traffic Routing](/docs/gardener/topology_aware_routing/#topology-aware-services-in-the-seed-cluster)).
...
It does not use [Topology-Aware Traffic Routing](/docs/gardener/topology_aware_routing/) since it contradicts the load balancing goal.
...
by the [`pod-kube-apiserver-load-balancing`](https://github.com/gardener/gardener/tree/master/pkg/resourcemanager/webhook/podkubeapiserverloadbalancing) webhook
...
![L7 load-balancing](/docs/gardener/images/l7-load-balancing.png)
