...
path_base_for_github_subdir:
  from: content/docs/gardener/logging.md
  to: logging.md
persona: Users
title: Logging
prev: false
...
![](/docs/gardener/images/logging-architecture.png)
...
![](/docs/gardener/images/shoot-node-logging-architecture.png)
...
![](/docs/gardener/images/explore-button-usage.png)
...
1. If you want to get the logs from `kubelet` systemd service of a given node and search for a pod name in the logs:
