...
path_base_for_github_subdir:
  from: content/docs/gardener/shoot/shoot_status.md
  to: shoot_status.md
persona: Users
title: Shoot Status
prev: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/usage/shoot/shoot_status.md
-->


# Shoot Status

This document provides an overview of the [ShootStatus](/docs/gardener/api-reference/core/#shootstatus).

## Conditions

The Shoot status consists of a set of conditions. A [Condition](/docs/gardener/api-reference/core/#condition) has the following fields:
...
The Shoot conditions are maintained by the [shoot care reconciler](https://github.com/gardener/gardener/blob/master/pkg/gardenlet/controller/shoot/care/reconciler.go) of the gardenlet.
Find more information in the [gardenlet documentation](/docs/gardener/concepts/gardenlet/#shoot-controller).
...
This constraint indicates whether all preconditions for a safe maintenance operation are satisfied (see [Shoot Maintenance](/docs/gardener/shoot/shoot_maintenance/) for more information about what happens during a shoot maintenance).
...
However, if it's visible, then a [credentials rotation operation](/docs/gardener/shoot-operations/shoot_credentials_rotation/#certificate-authorities) should be considered.
...
The Shoot status also contains information about the last occurred error(s) (if any) during an operation. A [LastError](/docs/gardener/api-reference/core/#lasterror) consists of identifier of the task returned error, human-readable message of the error and error codes (if any) associated with the error.
