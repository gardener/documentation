---
aliases:
  - /docs/gardener/shoot_control_plane_zone_pinning/
...
path_base_for_github_subdir:
  from: content/docs/gardener/shoot/shoot_control_plane_zone_pinning.md
  to: shoot_control_plane_zone_pinning.md
persona: Users
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/usage/shoot/shoot_control_plane_zone_pinning.md
-->


# Control Plane Zone Pinning

By default, the gardenlet automatically selects availability zones for the control plane components of a shoot cluster based on the seed's zone configuration and the shoot's worker pool zones (see [Zone Selection](/docs/gardener/seed_settings/#zone-selection)).
