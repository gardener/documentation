---
aliases:
  - /docs/gardener/shoot_scheduling_profiles/
...
path_base_for_github_subdir:
  from: content/docs/gardener/shoot/shoot_scheduling_profiles.md
  to: shoot_scheduling_profiles.md
persona: Users
title: Shoot Scheduling Profiles
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/usage/shoot/shoot_scheduling_profiles.md
-->
