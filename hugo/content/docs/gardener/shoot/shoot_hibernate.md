---
aliases:
  - /docs/gardener/shoot_hibernate/
description: >-
  What is hibernation? Manual hibernation/wake up and specifying a hibernation
  schedule
...
path_base_for_github_subdir:
  from: content/docs/gardener/shoot/shoot_hibernate.md
  to: shoot_hibernate.md
persona: Users
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/usage/shoot/shoot_hibernate.md
-->
