...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/usage/shoot/shoot_limits.md
-->
...
For more information, see the [NamespacedCloudProfile documentation](/docs/gardener/project/namespaced-cloud-profiles/#field-modification-restrictions).
...
The maximum node count of a shoot cluster can be lower than the configured limit, if the cluster's networking configurations don't allow it (see [this doc page](/docs/gardener/networking/shoot_networking/)).
