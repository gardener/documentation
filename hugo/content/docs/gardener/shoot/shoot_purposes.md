...
path_base_for_github_subdir:
  from: content/docs/gardener/shoot/shoot_purposes.md
  to: shoot_purposes.md
persona: Users
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/usage/shoot/shoot_purposes.md
-->
...
> [!NOTE]
> Shoot addons are deprecated and will be forbidden starting with Kubernetes version 1.35.

There are also differences with respect to how `testing` shoots are scheduled after creation, please consult the [Scheduler documentation](/docs/gardener/concepts/scheduler/).
