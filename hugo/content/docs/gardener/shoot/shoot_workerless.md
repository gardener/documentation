---
aliases:
  - /docs/gardener/shoot_workerless/
...
path_base_for_github_subdir:
  from: content/docs/gardener/shoot/shoot_workerless.md
  to: shoot_workerless.md
persona: Users
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/usage/shoot/shoot_workerless.md
-->
...
- extension components (if they support workerless `Shoot`s, see [here](/docs/gardener/extensions/resources/extension/#what-is-required-to-register-and-support-an-extension-type))
