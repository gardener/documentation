---
aliases:
  - /docs/gardener/shoot_auditpolicy/
description: >-
  How to define a custom audit policy through a `ConfigMap` and reference it in
  the shoot spec
...
path_base_for_github_subdir:
  from: content/docs/gardener/security/shoot_auditpolicy.md
  to: shoot_auditpolicy.md
persona: Users
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/usage/security/shoot_auditpolicy.md
-->
...
By default, the Gardener will deploy the shoot cluster with audit policy defined in the [kube-apiserver package](https://github.com/gardener/gardener/blob/master/pkg/component/kubernetes/apiserver/secrets.go).
...
If users want to immediately rollout Audit Policy changes, they can manually trigger a Shoot reconciliation as described in [triggering an immediate reconciliation](/docs/gardener/shoot-operations/shoot_operations/#immediate-reconciliation).
