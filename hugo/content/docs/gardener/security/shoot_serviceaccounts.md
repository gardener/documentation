---
aliases:
  - /docs/gardener/shoot_serviceaccounts/
github_repo: 'https://github.com/gardener/gardener'
github_subdir: docs/usage/security
params:
  github_branch: master
path_base_for_github_subdir:
  from: content/docs/gardener/security/shoot_serviceaccounts.md
  to: shoot_serviceaccounts.md
persona: Users
title: Shoot Serviceaccounts
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/usage/security/shoot_serviceaccounts.md
-->
...
- The Garden Cluster should have the Gardener Discovery Server deployed and configured.
  The easiest way to handle this is by using the [gardener-operator](/docs/gardener/concepts/operator/#gardener-discovery-server).
