---
aliases:
  - /docs/gardener/etcd_encryption_config/
description: >-
  Specifying resource types for encryption with
...
path_base_for_github_subdir:
  from: content/docs/gardener/security/etcd_encryption_config.md
  to: etcd_encryption_config.md
persona: Users
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/usage/security/etcd_encryption_config.md
-->
