---
aliases:
  - /docs/gardener/shoot_operations/
github_repo: 'https://github.com/gardener/gardener'
github_subdir: docs/usage/shoot-operations
params:
  github_branch: master
path_base_for_github_subdir:
  from: content/docs/gardener/shoot-operations/shoot_operations.md
  to: shoot_operations.md
persona: Users
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/usage/shoot-operations/shoot_operations.md
-->
...
Please consult [Credentials Rotation for Shoot Clusters](/docs/gardener/shoot-operations/shoot_credentials_rotation/) for more information.
...
- Shoot status contains at least one of the following [ErrorCodes](/docs/gardener/shoot/shoot_status/#error-codes):
