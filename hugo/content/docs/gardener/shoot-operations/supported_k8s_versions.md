---
aliases:
  - /docs/gardener/supported_k8s_versions/
github_repo: 'https://github.com/gardener/gardener'
github_subdir: docs/usage/shoot-operations
params:
  github_branch: master
path_base_for_github_subdir:
  from: content/docs/gardener/shoot-operations/supported_k8s_versions.md
  to: supported_k8s_versions.md
persona: Users
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/usage/shoot-operations/supported_k8s_versions.md
-->
...
> For more details, see [In-Place Updates of Pod Resources](/docs/gardener/autoscaling/in-place-resource-updates/).
...
> 👨🏼‍💻 Developers note: The [Adding Support For a New Kubernetes Version](/contribute/gardener/new-kubernetes-version/) topic explains what needs to be done in order to add support for a new Kubernetes version.
