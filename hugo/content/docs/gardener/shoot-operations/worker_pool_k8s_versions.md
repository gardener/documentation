---
aliases:
  - /docs/gardener/worker_pool_k8s_versions/
github_repo: 'https://github.com/gardener/gardener'
github_subdir: docs/usage/shoot-operations
params:
  github_branch: master
path_base_for_github_subdir:
  from: content/docs/gardener/shoot-operations/worker_pool_k8s_versions.md
  to: worker_pool_k8s_versions.md
persona: Users
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/usage/shoot-operations/worker_pool_k8s_versions.md
-->
...
Automatic updates of Kubernetes versions (see [Shoot Maintenance](/docs/gardener/shoot/shoot_maintenance/#automatic-version-updates)) also apply to worker pool Kubernetes versions.
