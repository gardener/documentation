---
aliases:
  - /docs/gardener/shoot_versions/
github_repo: 'https://github.com/gardener/gardener'
github_subdir: docs/usage/shoot-operations
params:
  github_branch: master
path_base_for_github_subdir:
  from: content/docs/gardener/shoot-operations/shoot_versions.md
  to: shoot_versions.md
persona: Users
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/usage/shoot-operations/shoot_versions.md
-->
...
For more information on how Gardener maps machine image versions to `CloudProvider` specific machine images, take a look at the individual gardener extension providers, such as the [provider for AWS](/docs/extensions/infrastructure-extensions/gardener-extension-provider-aws/operations/).
...
See [Automatic Version Updates](/docs/gardener/shoot/shoot_maintenance/#automatic-version-updates) for how to enable `auto updates` for Kubernetes or machine image versions on the Shoot cluster.
...
You might want to read about the [Shoot Updates and Upgrades](/docs/gardener/shoot-operations/shoot_updates/) procedures to get to know the effects of such operations.
