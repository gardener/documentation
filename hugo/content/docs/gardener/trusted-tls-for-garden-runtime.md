...
path_base_for_github_subdir:
  from: content/docs/gardener/trusted-tls-for-garden-runtime.md
  to: trusted-tls-for-garden-runtime.md
persona: Operators
title: Trusted Tls For Garden Runtime
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/operations/trusted-tls-for-garden-runtime.md
-->
