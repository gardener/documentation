...
path_base_for_github_subdir:
  from: content/docs/gardener/monitoring/connectivity.md
  to: connectivity.md
title: Connectivity
prev: false
next: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/monitoring/connectivity.md
-->
...
![image](/docs/gardener/monitoring/images/panel.png)
...
![image](/docs/gardener/monitoring/images/connectivity.png)
