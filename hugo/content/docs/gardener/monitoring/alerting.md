...
path_base_for_github_subdir:
  from: content/docs/gardener/monitoring/alerting.md
  to: alerting.md
title: Alerting
prev: false
next: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/monitoring/alerting.md
-->
...
![inhibitionGraph](/contribute/gardener/content/alertinhibitiongraph.png)
