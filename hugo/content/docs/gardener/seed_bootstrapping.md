...
path_base_for_github_subdir:
  from: content/docs/gardener/seed_bootstrapping.md
  to: seed_bootstrapping.md
persona: Operators
title: Seed Bootstrapping
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/operations/seed_bootstrapping.md
-->
