...
path_base_for_github_subdir:
  from: content/docs/gardenctl-v2/help/gardenctl_resolve_garden.md
  to: gardenctl_resolve_garden.md
title: Gardenctl Resolve Garden
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardenctl-v2/blob/master/docs/help/gardenctl_resolve_garden.md
-->
