...
path_base_for_github_subdir:
  from: content/docs/gardenctl-v2/help/gardenctl_kubectl-env_zsh.md
  to: gardenctl_kubectl-env_zsh.md
title: Gardenctl Kubectl Env Zsh
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardenctl-v2/blob/master/docs/help/gardenctl_kubectl-env_zsh.md
-->
