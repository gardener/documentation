...
path_base_for_github_subdir:
  from: content/docs/gardenctl-v2/help/gardenctl_config_view.md
  to: gardenctl_config_view.md
title: Gardenctl Config View
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardenctl-v2/blob/master/docs/help/gardenctl_config_view.md
-->
...
Print the gardenctl configuration
