...
path_base_for_github_subdir:
  from: content/docs/gardenctl-v2/help/gardenctl_target_seed.md
  to: gardenctl_target_seed.md
title: Gardenctl Target Seed
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardenctl-v2/blob/master/docs/help/gardenctl_target_seed.md
-->


# Gardenctl Target Seed
...
Target a seed to set the scope for the next operations

```
gardenctl target seed [flags]
```

### Examples

```
# target seed with name my-seed of currently selected garden
