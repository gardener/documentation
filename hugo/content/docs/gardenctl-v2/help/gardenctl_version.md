...
path_base_for_github_subdir:
  from: content/docs/gardenctl-v2/help/gardenctl_version.md
  to: gardenctl_version.md
title: Gardenctl Version
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardenctl-v2/blob/master/docs/help/gardenctl_version.md
-->
...
Print the gardenctl version information

```
gardenctl version [flags]
```
