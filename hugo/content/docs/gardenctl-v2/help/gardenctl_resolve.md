...
path_base_for_github_subdir:
  from: content/docs/gardenctl-v2/help/gardenctl_resolve.md
  to: gardenctl_resolve.md
title: Gardenctl Resolve
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardenctl-v2/blob/master/docs/help/gardenctl_resolve.md
-->
...
* [gardenctl resolve garden](/docs/gardenctl-v2/help/gardenctl_resolve_garden/)	 - Resolve garden for the current target
* [gardenctl resolve project](/docs/gardenctl-v2/help/gardenctl_resolve_project/)	 - Resolve project for the current target
* [gardenctl resolve seed](/docs/gardenctl-v2/help/gardenctl_resolve_seed/)	 - Resolve seed for the current target
* [gardenctl resolve shoot](/docs/gardenctl-v2/help/gardenctl_resolve_shoot/)	 - Resolve shoot for the current target
