...
path_base_for_github_subdir:
  from: content/docs/gardenctl-v2/help/gardenctl_rc_powershell.md
  to: gardenctl_rc_powershell.md
title: Gardenctl Rc Powershell
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardenctl-v2/blob/master/docs/help/gardenctl_rc_powershell.md
-->
