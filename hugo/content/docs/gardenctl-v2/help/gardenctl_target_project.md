...
path_base_for_github_subdir:
  from: content/docs/gardenctl-v2/help/gardenctl_target_project.md
  to: gardenctl_target_project.md
title: Gardenctl Target Project
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardenctl-v2/blob/master/docs/help/gardenctl_target_project.md
-->
...
```
# target project with name my-project of currently selected garden
