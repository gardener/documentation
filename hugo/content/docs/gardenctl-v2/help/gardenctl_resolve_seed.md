...
path_base_for_github_subdir:
  from: content/docs/gardenctl-v2/help/gardenctl_resolve_seed.md
  to: gardenctl_resolve_seed.md
title: Gardenctl Resolve Seed
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardenctl-v2/blob/master/docs/help/gardenctl_resolve_seed.md
-->
