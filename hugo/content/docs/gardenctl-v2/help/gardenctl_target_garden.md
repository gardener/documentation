...
path_base_for_github_subdir:
  from: content/docs/gardenctl-v2/help/gardenctl_target_garden.md
  to: gardenctl_target_garden.md
title: Gardenctl Target Garden
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardenctl-v2/blob/master/docs/help/gardenctl_target_garden.md
-->
