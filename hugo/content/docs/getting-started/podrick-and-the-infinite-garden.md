...
![cover picture of podrick and the infinite garden](/docs/getting-started/images/podrick/scene-0.webp)

* **Written by:** *The Gardener authors*
* **Inspiration:** [*The Illustrated Children's Guide to Kubernetes*](https://www.cncf.io/phippy/the-childrens-illustrated-guide-to-kubernetes/)
* **Illustrations:** *generated with [Gemini Nano Banana Pro](https://gemini.google/overview/image-generation/)*
...
To keep them alive, he needed plots (*Kubernetes clusters*).
Many plots in different environments but all with a similar set of features to ease maintenance efforts.

![podrick is an earthworm and main protagonist of the story](/docs/getting-started/images/podrick/podrick_no_logo.webp)

## *Explanation: Kubernetes Clusters*

* Host containerized workloads.
* Can be configured in many ways.
* Need to be scaled, updated and maintained regularly.

<img src="/docs/getting-started/images/podrick/icon_plot.webp" style="width: 50%" alt="a farm plot growing different vegetables representing a kubernetes cluster">
...
![podrick meets three raccoons that represent providers of kubernetes distributions](/docs/getting-started/images/podrick/scene-1.webp)
...
<img src="/docs/getting-started/images/podrick/icon_raccoon.webp" style="width: 50%" alt="raccoon representing a kubernetes provider">
...
![podrick meets the bees tending to a farm plot](/docs/getting-started/images/podrick/scene-2.webp)

---

Podrick traveled until he reached the Great Library of Plants (*The Garden cluster*).
It was a place of immense order.
The walls were lined with books and thousands of rolled-up parchments.

At the center sat the Botanist (*The Gardener API Server*).
...
![podrick meets the botanist in the great library of plants](/docs/getting-started/images/podrick/scene-3.webp)
...
<img src="/docs/getting-started/images/podrick/icon_library_outside.webp" style="width: 50%" alt="the great library of plants representing the garden cluster">
...
![podrick writes a scroll of desire that represents the shoot cluster definition](/docs/getting-started/images/podrick/scene-4.webp)
...
<img src="/docs/getting-started/images/podrick/icon_scrolls.webp" style="width: 50%" alt="a scroll representing the shoot resource">
...
"Gilly is one of many Gardenlets. She does not live here in the library. She lives in her own nursery (*The Seed Cluster*), but she watches my library constantly. The moment I stamped that scroll, she saw it."
...
![a mechanical hummingbird called gilly representing the gardenlet](/docs/getting-started/images/podrick/scene-5.webp)

## *Explanation: Gardenlet*
...
<img src="/docs/getting-started/images/podrick/icon_gilly_no_background.webp" style="width: 50%" alt="a mechanical hummingbird called gilly representing the gardenlet">

---

They arrived at the nursery (*The Seed Cluster*).
It was a massive, protected greenhouse.
Inside, Podrick saw something strange.
There were hundreds of beehives (*Control Planes*), all buzzing safely inside the glass walls.
...
![podrick with gilly in a nursery representing the seed cluster](/docs/getting-started/images/podrick/scene-6.webp)

## *Explanation: Seed Cluster*
...
<img src="/docs/getting-started/images/podrick/icon_nursery.webp" style="width: 50%" alt="a greenhouse which is the nursery representing the seed cluster">
...
![podrick and the infrastructure beavers arrived at the plot](/docs/getting-started/images/podrick/scene-7.webp)

## *Explanation: Infrastructure Extensions*
...
<img src="/docs/getting-started/images/podrick/icon_beaver_infra.webp" style="width: 50%" alt="beaver with a hardhat and sledge hammer representing the infrastructure extension">
...
![podrick, the infrastructure beavers and worker bees at the finished plot](/docs/getting-started/images/podrick/scene-8.webp)

## *Explanation: Machine Controller Manager*
...
<img src="/docs/getting-started/images/podrick/icon_beaver_mcm.webp" style="width: 50%" alt="beaver with a hardhat and shovel representing the machine controller manager">
...
![podrick and the botanist overlooking the many different nurseries and gillys](/docs/getting-started/images/podrick/scene-9.webp)
...
<img src="/docs/getting-started/images/podrick/icon_gilly_scaling.webp" style="width: 50%" alt="multiple mechanical hummingbirds representing multiple gardenlets">
...
![podrick and gilly back at the botanist's desk in the great library of plants](/docs/getting-started/images/podrick/scene-10.webp)
...
![podrick and the beavers back at the expanded plot](/docs/getting-started/images/podrick/scene-11.webp)

## *Explanation: Day-2 Operations*
...
![podrick and the raccoons in a living room in front of a cozy fireplace](/docs/getting-started/images/podrick/scene-12.webp)

## Glossary

| Illustration | Term | Definition |
| --- | --- | --- |
| <img src="/docs/getting-started/images/podrick/icon_plot.webp" style="width: 50%" alt="a farm plot growing different vegetables representing a kubernetes cluster"> | Kubernetes Cluster | Orchestrator of containerized workloads. |
| <img src="/docs/getting-started/images/podrick/icon_raccoon.webp" style="width: 50%" alt="raccoon representing a kubernetes provider"> | Providers | Offerings or tools to manage a Kubernetes cluster. |
| <img src="/docs/getting-started/images/podrick/icon_library_outside.webp" style="width: 50%" alt="the great library of plants representing the garden cluster"> | [Garden](/docs/gardener/concepts/operator/#garden-resources) | Management plane of the system where a user defines how their Kubernetes clusters should look like. |
| <img src="/docs/getting-started/images/podrick/icon_scrolls.webp" style="width: 50%" alt="a scroll representing the shoot resource"> | [Shoot](/docs/gardener/concepts/apiserver/#shoots) | Resource describing the desired and actual state of a Kubernetes cluster. |
| <img src="/docs/getting-started/images/podrick/icon_nursery.webp" style="width: 50%" alt="a greenhouse which is the nursery representing the seed cluster"> | [Seed](/docs/gardener/concepts/gardenlet/#seed-controller) | A Kubernetes cluster hosting other Kubernetes cluster's control planes as workloads. |
| <img src="/docs/getting-started/images/podrick/icon_gilly_no_background.webp" style="width: 50%" alt="a mechanical hummingbird called gilly representing the gardenlet"> | [Gardenlet](/docs/gardener/concepts/gardenlet/) | Just like a Kubelet for Nodes, a Gardenlet turns a Kubernetes cluster into a Seed. The Gardenlet has the core logic to manage Kubernetes clusters. |
| <img src="/docs/getting-started/images/podrick/icon_beaver_infra.webp" style="width: 50%" alt="beaver with a hardhat and sledge hammer representing the infrastructure extension"> | [Infrastructure Extensions](/docs/extensions/) | With knowledge about the actual infrastructure, they manage resources such as Virtual Private Clouds (VPCs). |
| <img src="/docs/getting-started/images/podrick/icon_beaver_mcm.webp" style="width: 50%" alt="beaver with a hardhat and shovel representing the machine controller manager"> | [Machine Controller Manager](/docs/other-components/machine-controller-manager/) | Responsible for the lifecycle of a Machine, which represents a Kubernetes cluster's Node. |
