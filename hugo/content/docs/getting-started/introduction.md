...
![universal-kubernetes](/docs/getting-started/images/universal-kubernetes.webp)
...
As of today, there are multiple adopters of Gardener, among which are SAP, STACKIT, Telekom, and Finanz Informatik Technologie Services GmbH. For a full list of adopters, see the [Adopters page](/adopter/).
