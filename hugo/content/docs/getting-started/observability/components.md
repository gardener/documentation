...
![core-components](/docs/getting-started/observability/images/core-components.webp)
...
![access-plutono](/docs/getting-started/observability/images/access-plutono.webp)
...
![welcome-plutono](/docs/getting-started/observability/images/welcome-plutono.webp)
...
![plutono](/docs/getting-started/observability/images/plutono.webp)
...
![explore-loki](/docs/getting-started/observability/images/explore-loki.webp)

1. Select `Vali` at the top left, as shown here:

![select-vali](/docs/getting-started/observability/images/select-vali.webp)

There you can browse logs or events of the control plane components.

![vali-logs](/docs/getting-started/observability/images/vali-logs.webp)
...
![data-flow-logging](/docs/getting-started/observability/images/data-flow-logging.webp)
