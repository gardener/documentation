...
path_base_for_github_subdir:
  from: content/docs/getting-started/features/hibernation.md
  to: hibernation.md
title: "Hibernation"
weight: 1
prev: false
...
![hibernation](/docs/getting-started/features/images/hibernation.gif)

### Data Plane

All nodes will be drained and the VMs will be deleted. As a result, all pods will be "stuck" in a `Pending` state since no new nodes are added. Of course, persistent volumes holding data are not deleted.
...
When waking up a cluster, all control plane components will be scaled up again and the DNS records will be recreated. Data plane nodes will be created again and pods can be scheduled to run on them.
...
![trigger-hibernation](/docs/getting-started/features/images/trigger-hibernation.webp)
