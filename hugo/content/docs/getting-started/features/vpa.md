...
Since it is not part of the standard Kubernetes API, you normally have to install the CRDs and controller manually. With Gardener, you can simply set `spec.kubernetes.verticalPodAutoscaler.enabled=true` in the shoot's spec and start creating your VPA objects.
