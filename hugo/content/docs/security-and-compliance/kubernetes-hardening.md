...
path_base_for_github_subdir:
  from: content/docs/security-and-compliance/kubernetes-hardening.md
  to: kubernetes-hardening.md
...
| 242403 | Kubernetes API Server must generate audit records that identify what type of event has occurred, identify the source of the event, contain the event results, identify any users, and identify any containers associated with the event | :x: | Users should set an audit policy that meets the requirements of their organization. Please consult the [Shoot Audit Policy documentation](/docs/gardener/security/shoot_auditpolicy/). |
| 242461 | Kubernetes API Server audit logs must be enabled | :x: | Users should set an audit policy that meets the requirements of their organization. Please consult the [Shoot Audit Policy documentation](/docs/gardener/security/shoot_auditpolicy/). |
