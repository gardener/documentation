---
description: Gardener extension controller for the Ubuntu operating system
github_repo: 'https://github.com/gardener/gardener-extension-os-ubuntu'
github_subdir: .
params:
  github_branch: master
path_base_for_github_subdir:
  from: content/docs/extensions/os-extensions/gardener-extension-os-ubuntu/_index.md
  to: README.md
title: Ubuntu OS
prev: false
next: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener-extension-os-ubuntu/blob/master/./README.md
-->
...
Please find [a concrete example](https://github.com/gardener/gardener-extension-os-ubuntu/blob/master/example/40-operatingsystemconfig.yaml) in the `example` folder.
...
An example for a `ControllerRegistration` resource that can be used to register this controller to Gardener can be found [here](https://github.com/gardener/gardener-extension-os-ubuntu/blob/master/example/controller-registration.yaml).
...
Please report bugs or suggestions as [GitHub issues](https://github.com/gardener/gardener-extension-os-ubuntu/issues) or reach out on [Slack](https://gardener-cloud.slack.com/) (join the workspace [here](https://gardener.cloud/community/#get-connected)).
