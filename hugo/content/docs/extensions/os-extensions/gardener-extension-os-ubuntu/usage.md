...
path_base_for_github_subdir:
  from: content/docs/extensions/os-extensions/gardener-extension-os-ubuntu/usage.md
  to: usage.md
persona: Users
title: Usage
prev: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener-extension-os-ubuntu/blob/master/docs/usage/usage.md
-->
