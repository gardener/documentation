---
description: Gardener extension controller for the AWS cloud provider
...
path_base_for_github_subdir:
  from: >-
    content/docs/extensions/infrastructure-extensions/gardener-extension-provider-aws/_index.md
  to: README.md
title: Provider AWS
prev: false
next: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener-extension-provider-aws/blob/master/./README.md
-->
...
| --- | --- | --- |
| Kubernetes 1.37 | 1.37.0+ | N/A |
| Kubernetes 1.36 | 1.36.0+ | [![Gardener v1.36 Conformance Tests](https://testgrid.k8s.io/q/summary/conformance-gardener/Gardener,%20v1.36%20AWS/tests_status?style=svg)](https://testgrid.k8s.io/conformance-gardener#Gardener,%20v1.36%20AWS) |
