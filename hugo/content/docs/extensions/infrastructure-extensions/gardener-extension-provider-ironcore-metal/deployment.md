...
path_base_for_github_subdir:
  from: >-
    content/docs/extensions/infrastructure-extensions/gardener-extension-provider-ironcore-metal/deployment.md
  to: deployment.md
persona: Operators
title: Deployment
prev: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/ironcore-dev/gardener-extension-provider-ironcore-metal/blob/main/docs/operations/deployment.md
-->


# Deployment of the metal provider extension
