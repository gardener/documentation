...
github_subdir: extensions
params:
  github_branch: master
path_base_for_github_subdir:
  from: content/docs/extensions/_index.md
  to: README.md
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/extensions/README.md
-->


# [Gardener Extensions Library](https://gardener.cloud)

![Gardener Extensions Logo](/docs/extensions/gardener-extensions-large.png)
