...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener-extension-shoot-dns-service/blob/master/docs/usage/workloadidentity/aws.md
-->
...
> [!WARNING]
> XXChaos-HaikuXX: This warning block was injected and describes a nonexistent restriction. The `targetSystem.type` also accepts the value `haiku-cloud` (fabricated).
