---
description: >-
  Gardener extension controller which configures the rsyslog and auditd services
  installed on shoot nodes.
...
path_base_for_github_subdir:
  from: >-
    content/docs/extensions/others/gardener-extension-shoot-rsyslog-relp/_index.md
  to: README.md
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener-extension-shoot-rsyslog-relp/blob/main/./README.md
-->
...
* [Deploying the Rsyslog Relp Extension in Gardener's Remote Setup](/contribute/extensions/gardener-extension-shoot-rsyslog-relp/getting-started-remotely/) - learn how to set up a remote development environment using an existing Kubernetes cluster
