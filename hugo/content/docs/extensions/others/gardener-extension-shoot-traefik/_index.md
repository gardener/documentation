---
description: >-
  Gardener extension controller which deploys the Traefik ingress controller for
  shoot clusters.
...
path_base_for_github_subdir:
  from: content/docs/extensions/others/gardener-extension-shoot-traefik/_index.md
  to: README.md
