...
path_base_for_github_subdir:
  from: content/docs/dashboard/access-restrictions.md
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/dashboard/blob/master/docs/operations/access-restrictions.md
-->


# Access Restrictions

For an overview and usage of access restrictions, refer to the [Access Restrictions Usage Documentation](/docs/gardener/shoot/access_restrictions/).
...
1. **Via Gardener Operator**: Configuration is provided through a ConfigMap referenced by the Gardener Operator.
