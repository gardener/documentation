...
path_base_for_github_subdir:
  from: content/docs/dashboard/migrate-secret-bindings.md
  to: migrate-secret-bindings.md
persona: Users
title: Migrate Secret Bindings
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/dashboard/blob/master/docs/usage/migrate-secret-bindings.md
-->
...
Follow [this](/docs/gardener/shoot-operations/secretbinding-to-credentialsbinding-migration/) link if you want to learn more about what the migration does.
...
1. A referenced `Secret` or `WorkloadIdentity` resource
...
* <img src="/docs/dashboard/images/mdi-key.svg" width="16"/> **Secret (SecretBinding)** → filled key icon
* <img src="/docs/dashboard/images/mdi-key-outline.svg" width="16"/> **Secret (CredentialsBinding)** → outlined key icon
* <img src="/docs/dashboard/images/mdi-id-card.svg" width="16"/> **WorkloadIdentity credentials** → card symbol (always referenced by a CredentialsBinding)
...
1. [Update all Shoots that still reference a `SecretBinding` to use the new `CredentialsBinding`](#step-2-migrate-clusters).
1. [Delete old `SecretBinding` resources after all Shoots have been migrated](#step-3-cleanup).
...
<img width="600" src="/docs/dashboard/images/sb-migration-button.png">
...
<img width="600" src="/docs/dashboard/images/sb-migration-dialog-1.png">
...
<img width="600" src="/docs/dashboard/images/sb-migration-dialog-2.png">
...
1. Click the key-change icon button (**Migrate Credential**) next to the credential information
1. A dialog opens where you can select a `CredentialsBinding`

You can only select a `CredentialsBinding` that references the **same Secret** as the currently used `SecretBinding`.

<img width="600" src="/docs/dashboard/images/sb-migration-shoot-1.png">

<img width="600" src="/docs/dashboard/images/sb-migration-shoot-2.png">
