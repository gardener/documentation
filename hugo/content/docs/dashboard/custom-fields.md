...
path_base_for_github_subdir:
  from: content/docs/dashboard/custom-fields.md
  to: custom-fields.md
persona: Users
title: Custom Fields
prev: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/dashboard/blob/master/docs/usage/custom-fields.md
-->
...
<img width="800" src="/docs/dashboard/images/custom-fields-1.png">

Click on the chip to show more details for the custom field configuration.

<img width="800" src="/docs/dashboard/images/custom-fields-2.png">
...
<img width="1400" src="/docs/dashboard/images/custom-fields-3.png">
...
<img width="800" src="/docs/dashboard/images/custom-fields-4.png">
...
1. Scroll down to the `Custom Fields for Shoots` section.
1. Click on the gear icon to open the configuration panel for custom fields.

<img width="800" src="/docs/dashboard/images/custom-fields-5.png">

### Adding a New Custom Field

1. In the `Configure Custom Fields for Shoot Clusters` panel, click on the `+ ADD NEW FIELD` button.

<img width="800" src="/docs/dashboard/images/custom-fields-6.png">
...
<img width="800" src="/docs/dashboard/images/custom-fields-7.png">
