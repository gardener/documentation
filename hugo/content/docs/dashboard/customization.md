...
path_base_for_github_subdir:
  from: content/docs/dashboard/customization.md
  to: customization.md
persona: Operators
title: Customization
prev: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/dashboard/blob/master/docs/operations/customization.md
-->
...
> We urge you to switch to a [`gardener-operator`](/docs/gardener/concepts/operator/)-based installation.
...
## Branding
It is possible to change the branding of the Gardener Dashboard when using the [helm chart](https://github.com/gardener/dashboard/tree/master/charts/gardener-dashboard) in the `frontendConfig.branding` map. The following configuration properties are supported:
...
You can replace individual icons in the [`assets`](https://github.com/gardener/dashboard/tree/master/frontend/public/static/assets) folder when deploying the Dashboard via the Helm chart by configuring the frontendConfig.assets map.
...
<img width="800" src="/docs/dashboard/images/customization-dark-1.png">
...
<img width="800" src="/docs/dashboard/images/customization-dark-2.png">
...
<img width="600" src="/docs/dashboard/images/customization-dark-3.png">
