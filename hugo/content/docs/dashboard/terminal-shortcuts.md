...
path_base_for_github_subdir:
  from: content/docs/dashboard/terminal-shortcuts.md
  to: terminal-shortcuts.md
persona: Users
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/dashboard/blob/master/docs/usage/terminal-shortcuts.md
-->
