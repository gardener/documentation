...
path_base_for_github_subdir:
  from: content/docs/dashboard/working-with-projects.md
  to: working-with-projects.md
persona: Users
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/dashboard/blob/master/docs/usage/working-with-projects.md
-->
...
1. Logon to the Gardener Dashboard and choose **CREATE YOUR FIRST PROJECT**.
    ...
    <img class="gs-image" src="/docs/dashboard/images/00-create-project.png">

1. Provide a project **Name**, and optionally a **Description** and a **Purpose**, and choose **CREATE**.
   
    <img class="gs-image" style="max-width:65%" src="/docs/dashboard/images/01-provide-project-details-public.png">
...
<img class="gs-image" src="/docs/dashboard/images/02-create-project-done.png">
...
<img class="gs-image" style="max-width:65%" src="/docs/dashboard/images/03-create-project-1.png">
...
For more information, see [Credentials Rotation for Shoot Clusters](/docs/gardener/shoot-operations/shoot_credentials_rotation/#cloud-provider-keys).

## Deleting Your Project

When you need to delete your project, go to **ADMINISTRATON**, choose the trash bin icon and, confirm the operation.

<img class="gs-image" src="/docs/dashboard/images/04-delete-project.png">
