...
Gardener-managed clusters deploy the [cluster autoscaler](https://github.com/kubernetes/autoscaler/tree/master/cluster-autoscaler) or CA for short and you can [tweak the general CA knobs](/docs/gardener/api-reference/core/#clusterautoscaler) for Gardener-managed clusters like this:
...
You will have to create specific `HorizontalPodAutoscaler` resources for your scale target and can [tweak the general HPA knobs](/docs/gardener/api-reference/core/#horizontalpodautoscalerconfig) for Gardener-managed clusters like this:
...
All channels for getting in touch or learning about the project are listed on our [Community page](/community/). We are cordially inviting interested parties to join our [bi-weekly meetings](/community/review-meetings/).
