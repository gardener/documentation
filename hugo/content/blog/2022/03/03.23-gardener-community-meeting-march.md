...
path_base_for_github_subdir:
  from: content/blog/2022/03/03.23-gardener-community-meeting-march.md
  to: 03.23-gardener-community-meeting-march.md
...
Now we would like to present the [Local Provider Extension](/docs/gardener/extensions/provider-local/) for Gardener and show how it can be used to deploy Gardener locally, allowing you to quickly get your feet wet with the project.
...
* [Deploying Gardener locally](/contribute/developer-starter-kit/getting_started_locally/)
