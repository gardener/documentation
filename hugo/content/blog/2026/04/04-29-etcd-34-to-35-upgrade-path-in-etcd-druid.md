---
aliases:
  - /blog/2026/04/29/etcd-34-to-35-upgrade-path-in-etcd-druid
authors:
...
1. **Version rollout** — Once the snapshot succeeds, etcd-druid updates the etcd container images in the StatefulSet, rolling out the new version.
1. **No snapshot on hibernation changes** — For etcd instances without backup configured (e.g., etcd-events), the version upgrade proceeds directly without a snapshot.
