...
aliases:
  - >-
    /blog/2026/05/05/workload-identity-eliminate-static-credentials-for-your-gardener-shoot-clusters
authors:
...
![Workload Identity Overview](/blog/2026/05/images/workload-identity-overview.png)
...
Use the value of `workloadIdentityIssuerURL` when configuring the OIDC identity provider in your cloud account. For more details, see the [Gardener Info ConfigMap documentation](/docs/gardener/configmap/).
...
For detailed instructions, see the [AWS Workload Identity Federation documentation](/docs/extensions/infrastructure-extensions/gardener-extension-provider-aws/usage/#aws-workload-identity-federation).
...
For detailed instructions, see the [Azure Workload Identity Federation documentation](/docs/extensions/infrastructure-extensions/gardener-extension-provider-azure/usage/#azure-workload-identity-federation).
...
For detailed instructions, see the [GCP Workload Identity Federation documentation](/docs/extensions/infrastructure-extensions/gardener-extension-provider-gcp/usage/#gcp-workload-identity-federation).
...
- [AWS Route53 with WorkloadIdentity](/docs/extensions/others/gardener-extension-shoot-dns-service/workloadidentity/aws/)
- [Azure DNS with WorkloadIdentity](/docs/extensions/others/gardener-extension-shoot-dns-service/workloadidentity/azure/)
- [Google Cloud DNS with WorkloadIdentity](/docs/extensions/others/gardener-extension-shoot-dns-service/workloadidentity/gcp/)
- [DNS Providers Configuration](/docs/extensions/others/gardener-extension-shoot-dns-service/dns_providers/)
...
For detailed instructions, see the [SecretBinding to CredentialsBinding migration guide](/docs/gardener/shoot-operations/secretbinding-to-credentialsbinding-migration/).
