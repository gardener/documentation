...
aliases:
  - >-
    /blog/2025/06/06-17-taking-gardener-to-the-next-level-highlights-from-the-7th-gardener-community-hackathon-in-schelklingen
authors:
...
![Group picture of the 7th Hack the Garden event in Schelklingen](/blog/2025/06/images/group-picture.webp)
...
A significant step towards Gardener's [Observability 2.0 initiative](/docs/proposals/0034-observability2.0-opentelemetry/) was made with the **OpenTelemetry Transport for `Shoot` Metrics** ([watch presentation](https://youtu.be/TCLXovw43HA?t=808s)).
