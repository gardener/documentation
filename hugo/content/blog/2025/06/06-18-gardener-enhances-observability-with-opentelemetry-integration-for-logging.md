...
aliases:
  - >-
    /blog/2025/06/18/gardener-enhances-observability-with-opentelemetry-integration-for-logging
authors:
...
* **Standardized Log Transport:** Logs from various sources will now be channeled through the OpenTelemetry Collector.
  ...
  * **Fluent Bit Integration:** Existing Fluent Bit instances, which act as log shippers on seed clusters, will be configured to forward logs to the OpenTelemetry Collector's receivers. This ensures continued compatibility with the Vali-based setup previously established by [GEP-19](/docs/proposals/0019-observability-stack-operator-migration/).
