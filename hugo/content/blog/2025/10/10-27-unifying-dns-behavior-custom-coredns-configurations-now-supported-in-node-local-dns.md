...
aliases:
  - >-
    /blog/2025/10/27/unifying-dns-behavior-custom-coredns-configurations-now-supported-in-node-local-dns
authors:
...
* **Documentation:** [Custom DNS configuration](/docs/gardener/networking/custom-dns-config/)
