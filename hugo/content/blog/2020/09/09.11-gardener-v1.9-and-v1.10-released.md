...
path_base_for_github_subdir:
  from: content/blog/2020/09/09.11-gardener-v1.9-and-v1.10-released.md
  to: 09.11-gardener-v1.9-and-v1.10-released.md
...
After we released our large logging stack refactoring (from EFK to Loki) with [Gardener v1.8](/blog/2020/08/08.06-gardener-v1.8.0-released/), we have continued to work on reliability, quality and user feedback in general.
