...
path_base_for_github_subdir:
  from: content/blog/2020/11/11.23-gardener-v1.13-released.md
  to: 11.23-gardener-v1.13-released.md
...
The alpha `NodeLocalDNS` feature was already [introduced and explained with Gardener v1.8](/blog/2020/08/08.06-gardener-v1.8.0-released/) with the motivation to overcome certain bottlenecks with the horizontally auto-scaled CoreDNS in all shoot clusters.
