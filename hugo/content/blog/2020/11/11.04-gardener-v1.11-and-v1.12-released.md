...
authors:
  - avatar: >-
      https://avatars2.githubusercontent.com/u/40451181?s=460&u=4df34635cf86b924700ef4152ec8462eeaa35721&v=4
    login: timuthy
    name: Tim Usner
...
path_base_for_github_subdir:
  from: content/blog/2020/11/11.04-gardener-v1.11-and-v1.12-released.md
  to: 11.04-gardener-v1.11-and-v1.12-released.md
...
Since release `v1.6`, Gardener has been capable of [reversing the tunnel direction](/contribute/gardener/reversed-vpn-tunnel/) from the seed to the shoot via the `KonnectivityTunnel` feature gate. With this release we make it possible to control the feature per shoot. We recommend to selectively enable the `KonnectivityTunnel`, as it is still in `alpha` state.
...
The Gardener community worked eagerly to deliver plenty of improvements with version v1.11. Those help us to further progress with topics like [control plane migration](/docs/proposals/0007-shoot-control-plane-migration/), which is actively being worked on, or to harden our load balancer consolidation ([APIServerSNI](/docs/proposals/0008-shoot-apiserver-via-sni/)) feature.
...
A full list of supported policies can be found at [Registering Extension Controllers](/docs/gardener/extensions/registration/#deployment-configuration-options).
