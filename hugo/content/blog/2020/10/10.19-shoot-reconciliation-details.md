...
authors:
  - avatar: >-
      https://avatars3.githubusercontent.com/u/33809186?s=400&u=92ab34a3539c11c498710aed9ddd1749032b36cb&v=4
    login: danielfoehrKn
    name: Daniel Foehr
...
path_base_for_github_subdir:
  from: content/blog/2020/10/10.19-shoot-reconciliation-details.md
  to: 10.19-shoot-reconciliation-details.md
...
The [Gardenlet](/docs/gardener/concepts/gardenlet/) contains the controller and reconciliation loop responsible for the creation, update, deletion, and migration of Shoot clusters (there are more, but we spare them in this article).
In addition, the [Gardener Controller Manager](/docs/gardener/concepts/controller-manager/) also reconciles Shoot resources, but only for seed-independent functionality such as Shoot hibernation, Shoot maintenance or quota control.
...
![Diagram](https://github.com/danielfoehrKn/diagrams/raw/master/gardener/shoot-reconciliation/gardener_reconcile_with_grid.png)
