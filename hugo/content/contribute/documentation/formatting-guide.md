---
aliases:
  - /docs/contribute/documentation/formatting-guide/
...
This page gives writing formatting guidelines for the Gardener documentation. For style guidelines, see the [Style Guide](/contribute/documentation/style-guide/).
...
| [Links and References](#links-and-references) | [link](/contribute/documentation/formatting-guide/) | `Visit the [Gardener website](https://gardener.cloud/)` |
...
Another thing to keep in mind is that markdown links do not work in certain [shortcodes](/contribute/documentation/shortcodes/) (e.g., mermaid). To circumvent this problem, you can use HTML links.
...
> [!NOTE]
> If a call to action appears inside a heading, use title case instead of sentence case. See [Creating Titles and Headings](/contribute/documentation/style-guide/#creating-titles-and-headings).
...
* [Style Guide](/contribute/documentation/style-guide/)
