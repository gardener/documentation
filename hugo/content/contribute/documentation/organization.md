---
aliases:
  - /docs/contribute/documentation/organization/
...
To have documentation published on the website, it is necessary to use the docforge manifests available at [gardener/documentation/.docforge](https://github.com/gardener/documentation/tree/master/.docforge) and register a reference to your documentation. For more information, see [Adding Existing Documentation](/contribute/documentation/adding-existing-documentation/).
