...
| :-- | :-- | :-- | :-- | :-- |
| Concept | Introduce a functionality or concept; covers background information. | [Services](https://kubernetes.io/docs/concepts/services-networking/service/) | [Overview, Relevant headings](/contribute/documentation/style-guide/concept_template/) | Concept |
| Reference | Provide a reference, for example, list all command line options of `gardenctl` and what they are used for. | [Overview of kubectl](https://kubernetes.io/docs/reference/kubectl/overview/) | [Relevant headings](/contribute/documentation/style-guide/reference_template/) | Reference |
| Task | A step-by-step description that allows users to complete a specific task. | [Upgrading kubeadm clusters](https://kubernetes.io/docs/tasks/administer-cluster/kubeadm/kubeadm-upgrade/) | [Overview, Prerequisites, Steps, Result](/contribute/documentation/style-guide/task_template/) | Complex Task |
...
See the [Contributors Guide](/contribute/) for more details on how to produce and contribute documentation.
...
- Content - The main part of the topic. It contains all the information relevant to the user
  - Concept content: [Overview, Relevant headings](/contribute/documentation/style-guide/concept_template/)
  - Task content: [Overview, Prerequisites, Steps, Result](/contribute/documentation/style-guide/task_template/)
  - Reference content: [Relevant headings](/contribute/documentation/style-guide/reference_template/)
...
For more information on the currently used tags, see [Blog Tags Reference](/contribute/documentation/blog-tags/).

### Alerts

If you want to add a note, tip or a warning to your topic, use the templates provides in the [Shortcodes](/contribute/documentation/shortcodes/#alerts) documentation.

### Images

If you want to add an image to your topic, it is recommended to follow the guidelines outlined in the [Images](/contribute/documentation/images/) documentation.
...
- [Formatting Guide](/contribute/documentation/formatting-guide/)
- [Contributors Guide](/contribute/)
- [Shortcodes](/contribute/documentation/shortcodes/)
- [Images](/contribute/documentation/images/)
