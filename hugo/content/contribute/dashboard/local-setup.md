...
path_base_for_github_subdir:
  from: content/contribute/dashboard/local-setup.md
  to: local-setup.md
persona: Developers
title: Local Setup
prev: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/dashboard/blob/master/docs/development/local-setup.md
-->
...
<p float="left">
<img width="90" src="/docs/dashboard/logo_gardener_dashboard.png">
...
See [`hack/local-dashboard/README.md`](https://github.com/gardener/dashboard/blob/master/hack/local-dashboard/README.md) for setup, commands, scenarios, and login.
...
1. **Alternative Method**: If you prefer not to run `yarn setup`, a temporary self-signed certificate will be generated automatically. This certificate will not be added to the keychain. Note that you will need to click through the insecure warning in your browser to access the dashboard.
...
Start the [`frontend`](https://github.com/gardener/dashboard/tree/master/frontend) dev server (`https://localhost:8443`) with https and hot reload enabled.
