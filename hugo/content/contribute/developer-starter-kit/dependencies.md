...
path_base_for_github_subdir:
  from: content/contribute/developer-starter-kit/dependencies.md
  to: dependencies.md
title: Dependencies
weight: 30
prev: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/development/dependencies.md
-->
...
The language version directive in the [`go.mod`](https://github.com/gardener/gardener/blob/master/go.mod) file should remain on the lowest supported Go version to avoid unnecessary restrictions for consumers of our packages.
...
1. Maintain the image variants of the [`golang-test`](https://github.com/gardener/gardener/tree/master/hack/tools/image) image used for unit- and integration testing as well as being the base image for `krte` (see next step) in the [`.github/workflows/golang-test-images.yaml`](https://github.com/gardener/gardener/blob/master/.github/workflows/golang-test-images.yaml) file.
...
1. Maintain the image variants of the [`krte`](https://github.com/gardener/ci-infra/tree/master/images/krte) image used for end-to-end testing in [KinD](https://kind.sigs.k8s.io/) in the [GitHub workflow](https://github.com/gardener/ci-infra/blob/master/.github/workflows/krte-images.yaml) used to build it.
...
5. Finally, update the Go version references inside this repository (mainly GitHub Actions workflows and image references) to the newer version ([example](https://github.com/gardener/gardener/pull/12753)).
   In the [`go.mod`](https://github.com/gardener/gardener/blob/master/go.mod) file, ensure that the language version directive and, if defined, the toolchain directive are set to the lowest supported Go version.
