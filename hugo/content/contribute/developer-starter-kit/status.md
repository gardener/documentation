...
path_base_for_github_subdir:
  from: content/contribute/developer-starter-kit/status.md
  to: status.md
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/development/status.md
-->
...
See the [shoot status documentation](/docs/gardener/shoot/shoot_status/) for more information.
