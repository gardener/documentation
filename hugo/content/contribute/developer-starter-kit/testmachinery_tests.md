...
path_base_for_github_subdir:
  from: content/contribute/developer-starter-kit/testmachinery_tests.md
  to: testmachinery_tests.md
title: Testmachinery Tests
weight: 50
prev: false
next: false
---
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/development/testmachinery_tests.md
-->
...
Gardener test machinery tests are split into two test suites that can be found under [`test/testmachinery/suites`](https://github.com/gardener/gardener/tree/master/test/testmachinery/suites):
...
The corresponding tests of a test suite are defined in the import statement of the suite definition (see [`shoot/run_suite_test.go`](https://github.com/gardener/gardener/blob/master/test/testmachinery/suites/shoot/run_suite_test.go))
and their source code can be found under [`test/testmachinery`](https://github.com/gardener/gardener/tree/master/test/testmachinery).
...
1. Import the test into the appropriate test suite (gardener or shoot): `import _ "github.com/gardener/gardener/test/testmachinery/shoot/security"`
1. Define your test with the testframework. The framework will automatically add its initialization, cleanup and dump functions.
```golang
