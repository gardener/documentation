...
path_base_for_github_subdir:
  from: content/contribute/developer-starter-kit/logging-guidelines.md
  to: logging-guidelines.md
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/development/logging-guidelines.md
-->
...
To ensure a smooth migration to logr and make logging in Gardener components more consistent, the [`logcheck` tool](https://github.com/gardener/gardener/tree/master/hack/tools/logcheck) was added.
It enforces (parts of) this guideline and detects programmer-level errors early on in order to prevent bugs.
Please check out the [tool's documentation](https://github.com/gardener/gardener/tree/master/hack/tools/logcheck) for a detailed description.
