...
path_base_for_github_subdir:
  from: content/contribute/other-components/machine-controller-manager/_index.md
  to: README.md
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/machine-controller-manager/blob/master/./README.md
-->
...
**Note**
One can add support for a new cloud provider by following [Adding support for new provider](/contribute/other-components/machine-controller-manager/cp_support_new/).
...
See [here](/docs/other-components/machine-controller-manager/documents/apis/) for CRD API Documentation
...
## FAQ
An FAQ is available [here](/docs/other-components/machine-controller-manager/faq/).
