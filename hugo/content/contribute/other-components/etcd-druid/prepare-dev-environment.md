...
path_base_for_github_subdir:
  from: content/contribute/other-components/etcd-druid/prepare-dev-environment.md
  to: prepare-dev-environment.md
persona: Developers
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/etcd-druid/blob/master/docs/development/prepare-dev-environment.md
-->
