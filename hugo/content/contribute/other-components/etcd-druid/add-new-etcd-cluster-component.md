...
path_base_for_github_subdir:
  from: >-
    content/contribute/other-components/etcd-druid/add-new-etcd-cluster-component.md
  to: add-new-etcd-cluster-component.md
persona: Developers
title: Add New Etcd Cluster Component
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/etcd-druid/blob/master/docs/development/add-new-etcd-cluster-component.md
-->
