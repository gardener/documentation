...
path_base_for_github_subdir:
  from: content/contribute/other-components/etcd-druid/updating-documentation.md
  to: updating-documentation.md
persona: Developers
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/etcd-druid/blob/master/docs/development/updating-documentation.md
-->
...
Once you have made the documentation changes then follow the guide on [how to raise a PR](/contribute/other-components/etcd-druid/raising-a-pr/).
