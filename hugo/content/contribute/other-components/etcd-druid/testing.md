...
path_base_for_github_subdir:
  from: content/contribute/other-components/etcd-druid/testing.md
  to: testing.md
persona: Developers
title: Testing
prev: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/etcd-druid/blob/master/docs/development/testing.md
-->
...
Detailed instructions on how to run e2e tests can be found [here](/contribute/other-components/etcd-druid/running-e2e-tests/).
