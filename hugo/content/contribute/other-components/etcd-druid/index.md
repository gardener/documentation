...
path_base_for_github_subdir:
  from: content/contribute/other-components/etcd-druid/_index.md
  to: README.md
title: etcd-druid
prev: false
next: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/etcd-druid/blob/master/./README.md
-->
...
If you wish to contribute then please see our [contributor guidelines](/contribute/other-components/etcd-druid/contribution/).
