...
path_base_for_github_subdir:
  from: content/contribute/other-components/etcd-druid/raising-a-pr.md
  to: raising-a-pr.md
persona: Developers
title: Raising A Pr
prev: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/etcd-druid/blob/master/docs/development/raising-a-pr.md
-->
...
In order to make code contributions you must setup your development environment. Follow the [Prepare Dev Environment Guide](/contribute/other-components/etcd-druid/prepare-dev-environment/) for detailed instructions.
...
* If you are making changes to the API then please read [Changing-API documentation](/contribute/other-components/etcd-druid/changing-api/).

* If you are introducing new go mod dependencies then please read [Dependency Management documentation](/contribute/other-components/etcd-druid/dependency-management/).

* If you are introducing a new `Etcd` cluster component then please read [Add new Cluster Component documentation](/contribute/other-components/etcd-druid/add-new-etcd-cluster-component/).

* For guidance on testing, follow the detailed instructions [here](/contribute/other-components/etcd-druid/testing/).
