...
path_base_for_github_subdir:
  from: >-
    content/contribute/extensions/infrastructure-extensions/gardener-extension-provider-azure/remote-setup.md
  to: remote-setup.md
persona: Developers
title: Remote Setup
prev: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener-extension-provider-azure/blob/master/docs/development/remote-setup.md
-->


# Remote Cluster Setup

This guide describes how to build and deploy the Azure provider extension to a remote Kubernetes cluster for development and testing.
