---
description: Developer documentation for the IronCore cloud provider extension
...
path_base_for_github_subdir:
  from: >-
    content/contribute/extensions/infrastructure-extensions/gardener-extension-provider-ironcore/_index.md
  to: README.md
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/ironcore-dev/gardener-extension-provider-ironcore/blob/main/./README.md
-->
...
[![GitHub License](https://img.shields.io/static/v1?label=License&message=Apache-2.0&color=blue)](https://github.com/ironcore-dev/gardener-extension-provider-ironcore/blob/main/LICENSE)
...
An example for a `ControllerRegistration` resource that can be used to register this controller to Gardener can be found [here](https://github.com/ironcore-dev/gardener-extension-provider-ironcore/blob/main/example/controller-registration.yaml).
...
Copyright 2025 SAP SE or an SAP affiliate company and IronCore contributors. Please see our [LICENSE](https://github.com/ironcore-dev/gardener-extension-provider-ironcore/blob/main/LICENSE) for
