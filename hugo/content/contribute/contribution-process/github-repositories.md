...
The source of truth for all repositories and their settings is the [`org.yaml`](https://github.com/gardener/org/blob/main/config/org.yaml) file in the [`gardener/org`](https://github.com/gardener/org) repository. A Peribolos job runs periodically and reconciles the actual state of the GitHub organization against the configuration declared in that file.
...
1. Open a pull request against [gardener/org](https://github.com/gardener/org) that modifies the relevant entry in [`config/org.yaml`](https://github.com/gardener/org/blob/main/config/org.yaml).
