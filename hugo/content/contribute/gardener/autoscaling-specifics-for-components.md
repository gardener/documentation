...
path_base_for_github_subdir:
  from: content/contribute/gardener/autoscaling-specifics-for-components.md
  to: autoscaling-specifics-for-components.md
persona: Developers
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/development/autoscaling-specifics-for-components.md
-->
...
The min replica count of 2 is imposed by the [High Availability of Shoot Control Plane Components](/contribute/gardener/high-availability-of-components/#control-plane-components).
