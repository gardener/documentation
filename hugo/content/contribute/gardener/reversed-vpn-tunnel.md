...
path_base_for_github_subdir:
  from: content/contribute/gardener/reversed-vpn-tunnel.md
  to: reversed-vpn-tunnel.md
persona: Developers
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/development/reversed-vpn-tunnel.md
-->
...
![VPN HA Architecture](/contribute/gardener/content/vpn-ha-architecture.png)
...
![Four possible routing paths](/contribute/gardener/content/vpn-ha-routing-paths.png)
