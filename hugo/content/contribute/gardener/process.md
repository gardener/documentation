...
path_base_for_github_subdir:
  from: content/contribute/gardener/process.md
  to: process.md
persona: Developers
title: Process
prev: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/development/process.md
-->
...
Click [here](/contribute/gardener/new-kubernetes-version/#kubernetes-release-responsible-plan) to view the Kubernetes Release Responsible plan.
...
In case you have to remove functionality *relevant to Gardener extensions*, please deprecate it first, and add a [TODO statement](#todo-statements) to remove it only after **at least 9 releases**.
...
In case you have to run migration code (*which is mostly internal*), please add a [TODO statement](#todo-statements) to remove it only after **3 releases**.
...
> [!TIP]
> Please revisit the [version skew policy](/docs/gardener/deployment/version_skew_policy/).
