...
path_base_for_github_subdir:
  from: content/contribute/gardener/remove-support-for-kubernetes-version.md
  to: remove-support-for-kubernetes-version.md
persona: Developers
title: Remove Support For Kubernetes Version
prev: false
next: false
---
<!-- BANNER:MANAGED -->
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/development/remove-support-for-kubernetes-version.md
-->
...
- Update the supported Kubernetes versions in the [`SupportedVersions` variable](https://github.com/gardener/gardener/blob/master/pkg/utils/validation/kubernetesversion/version.go) and in the [Supported Kubernetes Versions documentation](/docs/gardener/shoot-operations/supported_k8s_versions/). ([example](https://github.com/gardener/gardener/pull/12486/commits/16fa4cf56cdf85cf645c3ca1b739607b515669cb))
