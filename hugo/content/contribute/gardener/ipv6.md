...
path_base_for_github_subdir:
  from: content/contribute/gardener/ipv6.md
  to: ipv6.md
title: IPv6
prev: false
next: false
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/development/ipv6.md
-->
...
Please also take a look at the guide on [Deploying Gardener Locally](/contribute/developer-starter-kit/getting_started_locally/) for more details on setting up an IPv6 gardener for testing or development purposes.
...
Check the [component checklist](/contribute/gardener/component-checklist/#images) for tips concerning container registries and how to handle their IPv6 support.
