...
path_base_for_github_subdir:
  from: content/contribute/gardener/new-cloud-provider.md
  to: new-cloud-provider.md
persona: Developers
...
<!--
   ...
   └───────────│────────────────────────────────────┘
               ▼               
   https://github.com/gardener/gardener/blob/master/docs/development/new-cloud-provider.md
-->
...
| --- | --- | --- | --- |
| Seed or Shoot | Machine Lifecycle | [machine-controller-manager](https://github.com/gardener/machine-controller-manager) | [MCM new cloud provider](/contribute/other-components/machine-controller-manager/cp_support_new/) |
| Seed only | etcd backup/restore | [etcd-backup-restore](https://github.com/gardener/etcd-backup-restore/) | In process |
| All | Extension implementation | [gardener](https://github.com/gardener/gardener) | [Extension controller](/docs/gardener/extensions/) |
