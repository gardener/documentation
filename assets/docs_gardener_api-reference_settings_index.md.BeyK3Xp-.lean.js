import{c as r,o,j as e,a}from"./chunks/framework.Bfq10Vlj.js";const p=JSON.parse('{"title":"Settings","description":"","frontmatter":{"github_repo":"https://github.com/gardener/gardener","github_subdir":"docs/api-reference","params":{"github_branch":"master"},"path_base_for_github_subdir":{"from":"content/docs/gardener/api-reference/settings.md","to":"settings.md"},"title":"Settings","prev":false,"next":false},"headers":[],"relativePath":"docs/gardener/api-reference/settings/index.md","filePath":"docs/gardener/api-reference/settings.md","lastUpdated":null}'),i={name:"docs/gardener/api-reference/settings/index.md"},h=Object.assign(i,{setup(s){const n=`<p>Packages:</p>
<ul>
<li>
<a href="/docs/gardener/api-reference/settings/#settings.gardener.cloud/v1alpha1">settings.gardener.cloud/v1alpha1</a>
</li>
</ul>
...
Resource Types:
<ul><li>
<a href="/docs/gardener/api-reference/settings/#settings.gardener.cloud/v1alpha1.ClusterOpenIDConnectPreset">ClusterOpenIDConnectPreset</a>
</li><li>
<a href="/docs/gardener/api-reference/settings/#settings.gardener.cloud/v1alpha1.OpenIDConnectPreset">OpenIDConnectPreset</a>
</li></ul>
...
<code>spec</code></br>
<em>
<a href="/docs/gardener/api-reference/settings/#settings.gardener.cloud/v1alpha1.ClusterOpenIDConnectPresetSpec">
...
<em>
<a href="/docs/gardener/api-reference/settings/#settings.gardener.cloud/v1alpha1.OpenIDConnectPresetSpec">
...
<code>server</code></br>
<em>
<a href="/docs/gardener/api-reference/settings/#settings.gardener.cloud/v1alpha1.KubeAPIServerOpenIDConnect">
KubeAPIServerOpenIDConnect
</a>
</em>
</td>
<td>
<p>Server contains the kube-apiserver’s OpenID Connect configuration.
...
<code>client</code></br>
<em>
<a href="/docs/gardener/api-reference/settings/#settings.gardener.cloud/v1alpha1.OpenIDConnectClientAuthentication">
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/settings/#settings.gardener.cloud/v1alpha1.OpenIDConnectPresetSpec">OpenIDConnectPresetSpec</a>)
</p>
<p>
...
<td>
<em>(Optional)</em>
<p>List of allowed JOSE asymmetric signing algorithms. JWTs with a ‘alg’ header value not in this list will be rejected. Values are defined by RFC 7518 <a href="https://tools.ietf.org/html/rfc7518#section-3.1">https://tools.ietf.org/html/rfc7518#section-3.1</a>
Defaults to [RS256]</p>
</td>
</tr>
<tr>
...
<td>
<em>(Optional)</em>
<p>The OpenID claim to use as the user name. Note that claims other than the default (‘sub’) is not guaranteed to be unique and immutable. This field is experimental, please see the authentication documentation for further details.
Defaults to “sub”.</p>
</td>
</tr>
<tr>
...
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/settings/#settings.gardener.cloud/v1alpha1.OpenIDConnectPreset">OpenIDConnectPreset</a>, 
<a href="/docs/gardener/api-reference/settings/#settings.gardener.cloud/v1alpha1.ClusterOpenIDConnectPresetSpec">ClusterOpenIDConnectPresetSpec</a>)
</p>
<p>
...
</em></p>`;return(d,t)=>(o(),r("div",null,[t[0]||(t[0]=e("h1",{id:"settings",tabindex:"-1"},[a("Settings "),e("a",{class:"header-anchor",href:"#settings","aria-label":'Permalink to "Settings"'},"​")],-1)),e("div",{innerHTML:n})]))}});export{p as __pageData,h as default};
