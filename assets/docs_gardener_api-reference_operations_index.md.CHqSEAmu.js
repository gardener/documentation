import{c as a,o,j as e,a as s}from"./chunks/framework.Bfq10Vlj.js";const c=JSON.parse('{"title":"Operations","description":"","frontmatter":{"github_repo":"https://github.com/gardener/gardener","github_subdir":"docs/api-reference","params":{"github_branch":"master"},"path_base_for_github_subdir":{"from":"content/docs/gardener/api-reference/operations.md","to":"operations.md"},"title":"Operations","prev":false,"next":false},"headers":[],"relativePath":"docs/gardener/api-reference/operations/index.md","filePath":"docs/gardener/api-reference/operations.md","lastUpdated":null}'),d={name:"docs/gardener/api-reference/operations/index.md"},h=Object.assign(d,{setup(n){const r=`<p>Packages:</p>
<ul>
<li>
<a href="/docs/gardener/api-reference/operations/#operations.gardener.cloud/v1alpha1">operations.gardener.cloud/v1alpha1</a>
</li>
</ul>
...
Resource Types:
<ul><li>
<a href="/docs/gardener/api-reference/operations/#operations.gardener.cloud/v1alpha1.Bastion">Bastion</a>
</li></ul>
...
<code>spec</code></br>
<em>
<a href="/docs/gardener/api-reference/operations/#operations.gardener.cloud/v1alpha1.BastionSpec">
BastionSpec
</a>
</em>
</td>
...
<td>
<p>SSHPublicKey is the user’s public key. This field is immutable.</p>
</td>
</tr>
<tr>
<td>
...
<em>
<a href="/docs/gardener/api-reference/operations/#operations.gardener.cloud/v1alpha1.BastionIngressPolicy">
...
<code>status</code></br>
<em>
<a href="/docs/gardener/api-reference/operations/#operations.gardener.cloud/v1alpha1.BastionStatus">
BastionStatus
</a>
</em>
</td>
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operations/#operations.gardener.cloud/v1alpha1.BastionSpec">BastionSpec</a>)
</p>
<p>
...
<td>
<em>(Optional)</em>
<p>Conditions represents the latest available observations of a Bastion’s current state.</p>
</td>
</tr>
<tr>
<td>
...
Bastion’s generation, which is updated on mutation by the API Server.</p>
</td>
</tr>
</tbody>
</table>
...
</em></p>`;return(i,t)=>(o(),a("div",null,[t[0]||(t[0]=e("h1",{id:"operations",tabindex:"-1"},[s("Operations "),e("a",{class:"header-anchor",href:"#operations","aria-label":'Permalink to "Operations"'},"​")],-1)),e("div",{innerHTML:r})]))}});export{c as __pageData,h as default};
