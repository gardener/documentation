import{c as o,o as a,j as e,a as n}from"./chunks/framework.Bfq10Vlj.js";const c=JSON.parse('{"title":"Operator","description":"","frontmatter":{"github_repo":"https://github.com/gardener/gardener","github_subdir":"docs/api-reference","params":{"github_branch":"master"},"path_base_for_github_subdir":{"from":"content/docs/gardener/api-reference/operator.md","to":"operator.md"},"title":"Operator","prev":false,"next":false},"headers":[],"relativePath":"docs/gardener/api-reference/operator/index.md","filePath":"docs/gardener/api-reference/operator.md","lastUpdated":null}'),d={name:"docs/gardener/api-reference/operator/index.md"},l=Object.assign(d,{setup(i){const r=`<p>Packages:</p>
<ul>
<li>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1">operator.gardener.cloud/v1alpha1</a>
</li>
</ul>
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.Deployment">Deployment</a>)
</p>
<p>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.DeploymentSpec">
DeploymentSpec
</a>
</em>
</td>
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.GardenerAPIServerConfig">GardenerAPIServerConfig</a>, 
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.KubeAPIServerConfig">KubeAPIServerConfig</a>)
</p>
<p>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.AuthenticationWebhook">
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.Authentication">Authentication</a>)
</p>
<p>
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.ETCDMain">ETCDMain</a>)
</p>
<p>
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.VirtualCluster">VirtualCluster</a>)
</p>
<p>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.HighAvailability">
HighAvailability
</a>
</em>
</td>
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.GardenStatus">GardenStatus</a>)
</p>
<p>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.CredentialsRotation">
CredentialsRotation
</a>
</em>
</td>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.EncryptionAtRest">
EncryptionAtRest
</a>
</em>
</td>
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.Credentials">Credentials</a>)
</p>
<p>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.WorkloadIdentityKeyRotation">
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.DNSDomain">
[]DNSDomain
</a>
</em>
</td>
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.DNS">DNS</a>, 
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.Ingress">Ingress</a>)
</p>
<p>
...
<td>
<em>(Optional)</em>
<p>Provider is the name of the DNS provider as declared in the ‘.spec.dns.providers’ section.
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.GardenSpec">GardenSpec</a>)
</p>
<p>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.DNSProvider">
[]DNSProvider
</a>
</em>
</td>
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.DNSManagement">DNSManagement</a>)
</p>
<p>
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.GardenerDashboardConfig">GardenerDashboardConfig</a>)
</p>
<p>
...
Falls back to the API server’s OIDC client ID configuration if not set here.</p>
</td>
</tr>
<tr>
<td>
...
Falls back to the API server’s OIDC issuer URL configuration if not set here.</p>
</td>
</tr>
<tr>
<td>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.DashboardTerminalContainer">
...
‘<em>.seed.local.gardener.cloud’, or ‘</em>.other-seeds.local.gardener.cloud’. For more information, see
<a href="/docs/dashboard/webterminals/#allowlist-for-hosts">https://github.com/gardener/dashboard/blob/master/docs/operations/webterminals.md#allowlist-for-hosts</a>.</p>
</td>
</tr>
</tbody>
</table>
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.DashboardTerminal">DashboardTerminal</a>)
</p>
<p>
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.ExtensionSpec">ExtensionSpec</a>)
</p>
<p>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.ExtensionDeploymentSpec">
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.AdmissionDeploymentSpec">
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.AdmissionDeploymentSpec">AdmissionDeploymentSpec</a>, 
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.ExtensionDeploymentSpec">ExtensionDeploymentSpec</a>)
</p>
<p>
...
<code>helm</code></br>
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.ExtensionHelm">
ExtensionHelm
</a>
</em>
</td>
...
<code>main</code></br>
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.ETCDMain">
ETCDMain
</a>
</em>
</td>
...
<code>events</code></br>
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.ETCDEvents">
ETCDEvents
</a>
</em>
</td>
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.ETCD">ETCD</a>)
</p>
<p>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.Storage">
Storage
</a>
</em>
</td>
...
<code>backup</code></br>
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.Backup">
Backup
</a>
</em>
</td>
...
See <a href="/docs/gardener/concepts/operator/#etcd-encryption-config">https://github.com/gardener/gardener/blob/master/docs/concepts/operator.md#etcd-encryption-config</a> for more details.</p>
</td>
</tr>
</tbody>
</table>
...
<code>spec</code></br>
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.ExtensionSpec">
ExtensionSpec
</a>
</em>
</td>
...
<td>
<em>(Optional)</em>
<p>Resources is a list of combinations of kinds (DNSRecord, Backupbucket, …) and their actual types
(aws-route53, gcp).</p>
</td>
</tr>
<tr>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.Deployment">
Deployment
</a>
</em>
</td>
...
<code>status</code></br>
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.ExtensionStatus">
ExtensionStatus
</a>
</em>
</td>
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.DeploymentSpec">DeploymentSpec</a>)
</p>
<p>
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.Extension">Extension</a>)
</p>
<p>
...
<code>spec</code></br>
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.GardenSpec">
GardenSpec
</a>
</em>
</td>
...
<code>dns</code></br>
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.DNSManagement">
DNSManagement
</a>
</em>
</td>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.GardenExtension">
[]GardenExtension
</a>
</em>
</td>
...
<code>runtimeCluster</code></br>
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.RuntimeCluster">
RuntimeCluster
</a>
</em>
</td>
...
<code>virtualCluster</code></br>
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.VirtualCluster">
VirtualCluster
</a>
</em>
</td>
...
<code>status</code></br>
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.GardenStatus">
GardenStatus
</a>
</em>
</td>
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.Garden">Garden</a>)
</p>
<p>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.Credentials">
Credentials
</a>
</em>
</td>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.GardenerAPIServerConfig">
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.GardenerAdmissionControllerConfig">
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.GardenerControllerManagerConfig">
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.GardenerSchedulerConfig">
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.GardenerDashboardConfig">
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.GardenerDiscoveryServerConfig">
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.Gardener">Gardener</a>)
</p>
<p>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.AuditWebhook">
AuditWebhook
</a>
</em>
</td>
...
of requests that will be sent a GOAWAY. Min is 0 (off), Max is 0.02 (<sup>1</sup>⁄<sub>50</sub> requests); 0.001 (<sup>1</sup>⁄<sub>1000</sub>) is a
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.ResourceAdmissionConfiguration">
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.ProjectQuotaConfiguration">
...
<code>gitHub</code></br>
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.DashboardGitHub">
DashboardGitHub
</a>
</em>
</td>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.DashboardOIDC">
DashboardOIDC
</a>
</em>
</td>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.DashboardTerminal">
DashboardTerminal
</a>
</em>
</td>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.DashboardIngress">
DashboardIngress
</a>
</em>
</td>
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.ControlPlane">ControlPlane</a>)
</p>
<p>
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.RuntimeCluster">RuntimeCluster</a>)
</p>
<p>
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.Kubernetes">Kubernetes</a>)
</p>
<p>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.Authentication">
Authentication
</a>
</em>
</td>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.GroupResource">
[]GroupResource
</a>
</em>
</td>
...
<code>sni</code></br>
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.SNI">
SNI
</a>
</em>
</td>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.KubeAPIServerConfig">
KubeAPIServerConfig
</a>
</em>
</td>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.KubeControllerManagerConfig">
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.GardenerControllerManagerConfig">GardenerControllerManagerConfig</a>)
</p>
<p>
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.GardenerAdmissionControllerConfig">GardenerAdmissionControllerConfig</a>)
</p>
<p>
...
<code>limits</code></br>
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.ResourceLimit">
[]ResourceLimit
</a>
</em>
</td>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.ResourceAdmissionWebhookMode">
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.ResourceAdmissionConfiguration">ResourceAdmissionConfiguration</a>)
</p>
<p>
...
<code>ingress</code></br>
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.Ingress">
Ingress
</a>
</em>
</td>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.RuntimeNetworking">
RuntimeNetworking
</a>
</em>
</td>
...
<code>provider</code></br>
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.Provider">
Provider
</a>
</em>
</td>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.Settings">
Settings
</a>
</em>
</td>
...
<code>volume</code></br>
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.Volume">
Volume
</a>
</em>
</td>
...
<td>
<em>(Optional)</em>
<p>IPFamilies specifies the IP protocol versions to use for the runtime cluster’s networking. This field is
immutable.
Defaults to [“IPv4”].</p>
</td>
</tr>
...
If not configured, Gardener falls back to a secret labelled with ‘gardener.cloud/role=garden-cert’.</p>
</td>
</tr>
<tr>
<td>
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.Settings">Settings</a>)
</p>
<p>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.SettingLoadBalancerServices">
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.SettingVerticalPodAutoscaler">
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.SettingTopologyAwareRouting">
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.ETCDEvents">ETCDEvents</a>, 
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.ETCDMain">ETCDMain</a>)
</p>
<p>
<p>Storage contains storage configuration.</p>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.ControlPlane">
ControlPlane
</a>
</em>
</td>
...
<code>dns</code></br>
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.DNS">
DNS
</a>
</em>
</td>
...
<code>etcd</code></br>
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.ETCD">
ETCD
</a>
</em>
</td>
...
<code>gardener</code></br>
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.Gardener">
Gardener
</a>
</em>
</td>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.Kubernetes">
Kubernetes
</a>
</em>
</td>
...
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.Maintenance">
Maintenance
</a>
</em>
</td>
...
<code>networking</code></br>
<em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.Networking">
Networking
</a>
</em>
</td>
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/operator/#operator.gardener.cloud/v1alpha1.CredentialsRotation">CredentialsRotation</a>)
</p>
<p>
...
</em></p>`;return(p,t)=>(a(),o("div",null,[t[0]||(t[0]=e("h1",{id:"operator",tabindex:"-1"},[n("Operator "),e("a",{class:"header-anchor",href:"#operator","aria-label":'Permalink to "Operator"'},"​")],-1)),e("div",{innerHTML:r})]))}});export{c as __pageData,l as default};
