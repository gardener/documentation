import{c as d,o as a,j as e,a as o}from"./chunks/framework.Bfq10Vlj.js";const p=JSON.parse('{"title":"Security","description":"","frontmatter":{"github_repo":"https://github.com/gardener/gardener","github_subdir":"docs/api-reference","params":{"github_branch":"master"},"path_base_for_github_subdir":{"from":"content/docs/gardener/api-reference/security.md","to":"security.md"},"title":"Security","prev":false,"next":false},"headers":[],"relativePath":"docs/gardener/api-reference/security/index.md","filePath":"docs/gardener/api-reference/security.md","lastUpdated":null}'),i={name:"docs/gardener/api-reference/security/index.md"},h=Object.assign(i,{setup(n){const r=`<p>Packages:</p>
<ul>
<li>
<a href="/docs/gardener/api-reference/security/#security.gardener.cloud/v1alpha1">security.gardener.cloud/v1alpha1</a>
</li>
</ul>
...
Resource Types:
<ul><li>
<a href="/docs/gardener/api-reference/security/#security.gardener.cloud/v1alpha1.CredentialsBinding">CredentialsBinding</a>
</li><li>
<a href="/docs/gardener/api-reference/security/#security.gardener.cloud/v1alpha1.WorkloadIdentity">WorkloadIdentity</a>
</li></ul>
...
<em>
<a href="/docs/gardener/api-reference/security/#security.gardener.cloud/v1alpha1.CredentialsBindingProvider">
...
<code>spec</code></br>
<em>
<a href="/docs/gardener/api-reference/security/#security.gardener.cloud/v1alpha1.WorkloadIdentitySpec">
...
The values of this field will be set in the ‘aud’ claim.</p>
</td>
</tr>
<tr>
<td>
...
<em>
<a href="/docs/gardener/api-reference/security/#security.gardener.cloud/v1alpha1.TargetSystem">
TargetSystem
</a>
</em>
</td>
...
<code>status</code></br>
<em>
<a href="/docs/gardener/api-reference/security/#security.gardener.cloud/v1alpha1.WorkloadIdentityStatus">
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/security/#security.gardener.cloud/v1alpha1.TokenRequestSpec">TokenRequestSpec</a>)
</p>
<p>
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/security/#security.gardener.cloud/v1alpha1.WorkloadIdentitySpec">WorkloadIdentitySpec</a>)
</p>
<p>
<p>TargetSystem represents specific configurations for the system that will accept the JWTs.</p>
</p>
...
<code>spec</code></br>
<em>
<a href="/docs/gardener/api-reference/security/#security.gardener.cloud/v1alpha1.TokenRequestSpec">
TokenRequestSpec
</a>
</em>
</td>
...
<em>
<a href="/docs/gardener/api-reference/security/#security.gardener.cloud/v1alpha1.ContextObject">
ContextObject
</a>
</em>
</td>
...
<code>status</code></br>
<em>
<a href="/docs/gardener/api-reference/security/#security.gardener.cloud/v1alpha1.TokenRequestStatus">
TokenRequestStatus
</a>
</em>
</td>
...
<p>
(<em>Appears on:</em>
<a href="/docs/gardener/api-reference/security/#security.gardener.cloud/v1alpha1.TokenRequest">TokenRequest</a>)
</p>
<p>
...
</em></p>`;return(s,t)=>(a(),d("div",null,[t[0]||(t[0]=e("h1",{id:"security",tabindex:"-1"},[o("Security "),e("a",{class:"header-anchor",href:"#security","aria-label":'Permalink to "Security"'},"​")],-1)),e("div",{innerHTML:r})]))}});export{p as __pageData,h as default};
