...
* **Standardized Log Transport:** Logs from various sources will now be channeled through the OpenTelemetry Collector.
  ...
  * **Fluent Bit Integration:** Existing Fluent Bit instances, which act as log shippers on seed clusters, will be configured to forward logs to the OpenTelemetry Collector's receivers. This ensures continued compatibility with the Vali-based setup previously established by [GEP-19](https://github.com/gardener/enhancements/blob/main/geps/0019-observability-stack-operator-migration/README.md).
