...
![cover picture of podrick and the infinite garden](./images/podrick/scene-0.webp)
...
![podrick is an earthworm and main protagonist of the story](./images/podrick/podrick_no_logo.webp)
...
<img src="./images/podrick/icon_plot.webp" style="width: 50%" alt="a farm plot growing different vegetables representing a kubernetes cluster">
...
![podrick meets three raccoons that represent providers of kubernetes distributions](./images/podrick/scene-1.webp)
...
<img src="./images/podrick/icon_raccoon.webp" style="width: 50%" alt="raccoon representing a kubernetes provider">
...
![podrick meets the bees tending to a farm plot](./images/podrick/scene-2.webp)
...
![podrick meets the botanist in the great library of plants](./images/podrick/scene-3.webp)
...
<img src="./images/podrick/icon_library_outside.webp" style="width: 50%" alt="the great library of plants representing the garden cluster">
...
![podrick writes a scroll of desire that represents the shoot cluster definition](./images/podrick/scene-4.webp)
...
<img src="./images/podrick/icon_scrolls.webp" style="width: 50%" alt="a scroll representing the shoot resource">
...
![a mechanical hummingbird called gilly representing the gardenlet](./images/podrick/scene-5.webp)
...
<img src="./images/podrick/icon_gilly_no_background.webp" style="width: 50%" alt="a mechanical hummingbird called gilly representing the gardenlet">
...
![podrick with gilly in a nursery representing the seed cluster](./images/podrick/scene-6.webp)
...
<img src="./images/podrick/icon_nursery.webp" style="width: 50%" alt="a greenhouse which is the nursery representing the seed cluster">
...
![podrick and the infrastructure beavers arrived at the plot](./images/podrick/scene-7.webp)
...
<img src="./images/podrick/icon_beaver_infra.webp" style="width: 50%" alt="beaver with a hardhat and sledge hammer representing the infrastructure extension">
...
![podrick, the infrastructure beavers and worker bees at the finished plot](./images/podrick/scene-8.webp)
...
<img src="./images/podrick/icon_beaver_mcm.webp" style="width: 50%" alt="beaver with a hardhat and shovel representing the machine controller manager">
...
![podrick and the botanist overlooking the many different nurseries and gillys](./images/podrick/scene-9.webp)
...
<img src="./images/podrick/icon_gilly_scaling.webp" style="width: 50%" alt="multiple mechanical hummingbirds representing multiple gardenlets">
...
![podrick and gilly back at the botanist's desk in the great library of plants](./images/podrick/scene-10.webp)
...
![podrick and the beavers back at the expanded plot](./images/podrick/scene-11.webp)
...
<img src="./images/podrick/icon_day2_operations.webp" style="width: 50%" alt="scrolls, the mechanical hummingbird, and the beehive representing day-2 operations">
...
![podrick and the raccoons in a living room in front of a cozy fireplace](./images/podrick/scene-12.webp)

## Glossary

| Illustration                                                                                                                                                 | Term                                                                                                       | Definition                                                                                                                                         |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------|
| <img src="./images/podrick/icon_plot.webp" style="width: 50%" alt="a farm plot growing different vegetables representing a kubernetes cluster">                | Kubernetes Cluster                                                                                         | Orchestrator of containerized workloads.                                                                                                           |
| <img src="./images/podrick/icon_raccoon.webp" style="width: 50%" alt="raccoon representing a kubernetes provider">                                             | Providers                                                                                                  | Offerings or tools to manage a Kubernetes cluster.                                                                                                 |
| ![the great library of plants representing the garden cluster](./images/podrick/icon_library_outside.webp)                    | [Garden](https://github.com/gardener/gardener/blob/master/docs/concepts/operator.md#garden-resources)      | Management plane of the system where a user defines how their Kubernetes clusters should look like.                                                |
| ![a scroll representing the shoot resource](./images/podrick/icon_scrolls.webp)                                               | [Shoot](https://github.com/gardener/gardener/blob/master/docs/concepts/apiserver.md#shoots)                | Resource describing the desired and actual state of a Kubernetes cluster.                                                                          |
| ![a greenhouse which is the nursery representing the seed cluster](./images/podrick/icon_nursery.webp)                        | [Seed](https://github.com/gardener/gardener/blob/master/docs/concepts/gardenlet.md#seed-controller)        | A Kubernetes cluster hosting other Kubernetes cluster's control planes as workloads.                                                               |
| ![a mechanical hummingbird called gilly representing the gardenlet](./images/podrick/icon_gilly_no_background.webp)           | [Gardenlet](https://github.com/gardener/gardener/blob/master/docs/concepts/gardenlet.md)                   | Just like a Kubelet for Nodes, a Gardenlet turns a Kubernetes cluster into a Seed. The Gardenlet has the core logic to manage Kubernetes clusters. |
| ![beaver with a hardhat and sledge hammer representing the infrastructure extension](./images/podrick/icon_beaver_infra.webp) | [Infrastructure Extensions](https://github.com/gardener/gardener/blob/master/extensions/README.md)         | With knowledge about the actual infrastructure, they manage resources such as Virtual Private Clouds (VPCs).                                       |
| ![beaver with a hardhat and shovel representing the machine controller manager](./images/podrick/icon_beaver_mcm.webp)        | [Machine Controller Manager](https://github.com/gardener/machine-controller-manager/blob/master/README.md) | Responsible for the lifecycle of a Machine, which represents a Kubernetes cluster's Node.                                                          |
