...
There is another benefit of not running control plane components and user workloads in the same cluster. It prevents user issues to cause degradation of their control plane components.
