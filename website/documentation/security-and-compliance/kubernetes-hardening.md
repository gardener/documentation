...
|242403|Kubernetes API Server must generate audit records that identify what type of event has occurred, identify the source of the event, contain the event results, identify any users, and identify any containers associated with the event| :x: | Users should set an audit policy that meets the requirements of their organization. Please consult the [Shoot Audit Policy documentation](https://github.com/gardener/gardener/blob/master/docs/usage/security/shoot_auditpolicy.md).|
|242461|Kubernetes API Server audit logs must be enabled| :x: | Users should set an audit policy that meets the requirements of their organization. Please consult the [Shoot Audit Policy documentation](https://github.com/gardener/gardener/blob/master/docs/usage/security/shoot_auditpolicy.md).|
