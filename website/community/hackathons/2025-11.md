...
![concept diagram for the gardener scale-out tests using hollow clusters and gardenlets to simulate load](images/2025-11/scale-out-tests/concept.webp)
...
![Prow CPU metrics without cache showing 12 CPUs being used during build](images/2025-11/prow-go-build-cache/prow-without-cache.webp)
...
![Prow CPU metrics with cache showing 2 CPUs being used during build](images/2025-11/prow-go-build-cache/prow-with-cache.webp)
...
The API server of a [self-hosted `Shoot` cluster](https://github.com/gardener/enhancements/blob/main/geps/0028-self-hosted-shoot-clusters/README.md) with managed infrastructure needs a mechanism to be reliably exposed for external access.
